...
Version: v3.212.0
Slice: Plan 36 read-phase (`.ai-memory/plans/pending/60-plan36-app-shell-src-v3-read-phase.md`).

## Scope

Plan 36 file: `.ai-memory/plans/pending/36-ui-app-shell-and-src-v3-port.md`. Two
threads:
...
`rg -n 'app shell|src v3|chrome'` over `02-spec/` returned no direct anchor
files this turn. Deferring detailed spec citations until step 2 grep expands
into `02-spec/21-app/` and `02-spec/24-app-ui-design-system/`.

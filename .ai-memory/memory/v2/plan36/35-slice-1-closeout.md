...
- `.ai-memory/memory/v2/plan36/30-slice-1.md` (scope memo).
- `.ai-memory/memory/v2/plan36/35-slice-1-closeout.md` (this memo).
...
Plan 62 (`.ai-memory/plans/pending/62-plan36-theme-tokens-migration.md`)
executes next per the group-A ordering in `.ai-memory/plan.md`. Plan 36

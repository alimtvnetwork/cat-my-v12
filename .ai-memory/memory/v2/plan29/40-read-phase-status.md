...
- Steps 16-22 spec phase: threshold-tuning.md spec under `02-spec/22-security/` (folder does not exist; likely repathed to `02-spec/21-app/69*` per plan 29 REPATHED note).
...
- Sub-plans queued: `.ai-memory/plans/pending/49-plan29-threshold-derivation.md`, `50-plan29-rollout-and-observability.md`.

## Blockers

- Field data insufficient (12-row fixture); park decision recorded at `.ai-memory/plans/subtasks/29-denial-burst-threshold-tuning/05-park-decision.md`. Unblocks on larger telemetry export.

...
All non-blocked items are done as of v3.531.0. Remaining rows are gated on the Plan 77 dispatch answers or the external worker-process build (I-BE-04). See `.ai-memory/ambiguity-questions/04-plan77-dispatch.md`.

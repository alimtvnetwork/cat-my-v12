...
Plan 39 is a 30-step onboarding sweep of `02-spec/02-coding-guidelines/`,
`02-spec/03-error-manage/`, and `02-spec/21-app/`, followed by a `src/` walk and
...
- `02-spec/21-app/`: 67 entries (files + subfolders). Steps 11-18 cover this tree.
- `02-spec/02-coding-guidelines/`: overview + 10 subfolders (`01-cross-language`,
...
- `02-spec/17-consolidated-guidelines/`: 33 files (cross-ref plan 38 memo).
...
- Steps 19-25 (`src/` walk) are one-shell-ls deep; nothing has been
  memorized yet.
- Steps 26-30 (`.ai-memory/memory/20-product-model.md`,
  `.ai-memory/memory/21-code-map.md`, UI + data gap matrices) not written
  this slice. No fabricated product model.
- Plan 39 stays in `.ai-memory/plans/pending/`.

...
- Suspect files: `src/routes/index.tsx`, `.ai-memory/02-spec/commands/09-home-hub-top-nav.md`.
...
- Acceptance: `src_v3/` removed; `rg "src_v3"` outside `.ai-memory/plans/completed/` and archived memory returns zero matches in `src/`.

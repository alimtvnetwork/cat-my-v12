...
Issue 16 (`.ai-memory/issues/16-project-section-create-flow-broken.md`) remains the sole `Status: open` entry across `.ai-memory/issues/`. It is parked on user answers to `.ai-memory/ambiguity-questions/01-ui-v2-open-questions.md`.

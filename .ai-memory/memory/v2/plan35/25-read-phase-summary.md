...
- Error registry: wire codes in `02-spec/21-app/40-error-manage.md:131-133`.

## Open gaps (blast radius ascending)

1. Spec docs: `02-spec/21-app/**` narrative for Layers-vs-Properties contract + drag/drop/group/merge (Plan 35 steps 24-25). Docs-only, no runtime risk. -> Plan 57 owns this.
...
- `ls .ai-memory/memory/v2/plan35/` shows 00, 01, 02, 03, 04, 25 memo files.

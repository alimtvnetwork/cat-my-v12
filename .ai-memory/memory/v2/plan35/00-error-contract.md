...
`02-spec/21-app/40-error-manage.md:131-133` registers all three wire codes:
...
`02-spec/03-error-manage/98-changelog.md:13` records the registration entry.
...
three-tier error architecture (`02-spec/03-error-manage/02-error-architecture.md`).

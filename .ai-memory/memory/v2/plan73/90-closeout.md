...
Status: completed
Closed: 2026-07-18
Plan file: `.ai-memory/plans/completed/73-ui-issues-closeout-sweep.md`
...
Token `--ca-on-primary` (oklch(0.16 0.02 300)) plus tinted-primary active-pill pattern (`border-ca-primary/60 bg-ca-primary/25 text-ca-ink`). Documented in `.ai-memory/memory/04-design-system.md`.

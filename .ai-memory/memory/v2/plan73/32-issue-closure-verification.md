...
description: Sweep of `.ai-memory/issues/*` statuses after closing 17-26; allowlist of intentionally-open older issues out of Plan 73 scope
type: reference
---

Command: `for f in .ai-memory/issues/*.md; do grep -Hi '^Status' $f | head -1; done`

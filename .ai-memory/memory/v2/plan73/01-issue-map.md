...
Read pass 2026-07-18 across `.ai-memory/issues/17-*.md` through `.ai-memory/issues/26-*.md`. Two issues (18, 22, 24) already closed by prior plans, retained here for regression coverage. Remainder still `open`.

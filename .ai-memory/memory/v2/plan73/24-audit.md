...
Issue file: `.ai-memory/issues/24-setup-rules-form-ui-and-category-picker.md`
...
`rg -n "status:\s*open" .ai-memory/issues/24-setup-rules-form-ui-and-category-picker.md` -> no match.

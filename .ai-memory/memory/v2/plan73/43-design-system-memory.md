...
description: Records the new --ca-on-primary token, the tinted-pill active pattern, and the closed-issue refs (17,19,20,21,23,25,26) into .ai-memory/memory/04-design-system.md.
type: reference
---
...
Update: appended a "Plan 73 closeout tokens (v3.507.0, 2026-07-18)" section to `.ai-memory/memory/04-design-system.md` documenting:

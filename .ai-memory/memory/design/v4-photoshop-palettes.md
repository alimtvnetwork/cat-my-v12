...
Source of truth: `02-spec/21-app/53-ui-improvements-v4.md` (section 3, section 5, section 8).
...
- Tools rail: `02-spec/21-app/instruction-images-v4/01-tools-panel-photoshop.png`

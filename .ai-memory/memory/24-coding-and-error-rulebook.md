...
description: Distilled operating rules from 02-spec/02-coding-guidelines and 02-spec/03-error-manage; naming, TS style, error architecture, security, CI gates
type: preference
---
...
- Registered but undocumented `CAT` (Control Automation UI) codes reference `02-spec/21-app/40-error-manage.md` and `02-spec/24-app-ui-design-system/07-errors-logging.md` as future homes for `E_LAYER_*`/`W_LAYER_*`/`I_UI_*`. [03/03/01 L63]

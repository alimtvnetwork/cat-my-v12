...
Consolidated summaries (recommended first stop): `02-spec/17-consolidated-guidelines/` mirrors each folder as a single AI-optimized file (e.g. `05-split-db-architecture.md`, `06-seedable-config.md`, `15-cicd-pipeline-workflows.md`).

# `.ai-memory/` Folder Guide

Structural map of the `.ai-memory/` control tree. Read this before touching any file here.
...
| `02-spec/commands/`                         | Command specs invoked by aliases.                                             | Add commands here; then link from `prompt.md`.                     |
...
| `06-spec-map.md`               | Full `02-spec/` map + `.ai-memory/` inventory    |
...
- `mem://index.md` lists design/tokens memory; the `.ai-memory/memory/` files own project-rule memory.

# Design System (from 02-spec/07-design-system + 02-spec/17-consolidated-guidelines/07)
...
- Canonical: `02-spec/07-design-system/00-overview.md`
- Condensed: `02-spec/17-consolidated-guidelines/07-design-system.md`
- App-specific: `02-spec/24-app-ui-design-system/`
- Project brief: `mem://design/hmi-brief`, tokens `mem://design/hmi-tokens`

## Plan 30 QA evidence (v3.74.0, 2026-07-15)

Ship-gate reports for the editor design system (per `02-spec/24-app-ui-design-system/08-testing.md`):
...
Subtasks: SS-01 gap matrix, SS-02 schema migration, SS-03 panel token map, SS-04 test-hook contract under `.ai-memory/plans/subtasks/31-pre-93-panel-gaps-completion/`.

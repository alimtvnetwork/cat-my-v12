...
According to the coding guidelines (`02-spec/coding-guidelines/coding-guidelines.md`), there must be **one blank line before every `return` or `throw`**, unless it is the only statement in the block.

...
**Scope:** Full repo — `src/`, `BE/`, `app/`, `02-spec/`, `.ai-memory/`, tests, shell

**Also see:** [`.ai-memory/overview.md`](../overview.md) (living project overview with diagrams) · [`.ai-memory/ai-improvement-guidelines.md`](../ai-improvement-guidelines.md) (AI action items)
...
### Process model (02-spec/21-app/12-runtime-processes.md)
...
| `02-spec/`           | Markdown                                                   | Source-of-truth specifications (~1900 files)                       |
...
- Custom linters, magic-string checks, guideline docs in `02-spec/02-coding-guidelines/`
...
- Plans in `.ai-memory/plans/`, closeouts in `.ai-memory/memory/`
...
Coding guidelines (`02-spec/02-coding-guidelines/00-overview.md`):
...
`.ai-memory/plans/`, `.ai-memory/memory/`, `02-spec/`, linter fixtures mirroring spec paths — enormous process surface. Helps AI serial execution; humans pay navigation tax. "Where is truth?" often means spec + plan + code + test together.
...
### Split DB (02-spec/05-split-db-architecture/)
...
| Topic                       | Location                                                                                                           |
| --------------------------- | ------------------------------------------------------------------------------------------------------------------ |
| Product overview            | `README.md`, `02-spec/21-app/10-app-overview.md`                                                                      |
| Runtime processes           | `02-spec/21-app/12-runtime-processes.md`                                                                              |
| Shell architecture (target) | `02-spec/21-app/shell/02-runtime-architecture.md`                                                                     |
| BE layout                   | `BE/README.md`                                                                                                     |
| Coding guidelines           | `02-spec/02-coding-guidelines/00-overview.md`                                                                         |
| Error envelope              | `02-spec/03-error-manage/`, `BE/envelope.py`, `src/lib/backend/envelope.ts`                                           |
| Facade backlog              | `.ai-memory/pending-facades/`                                                                                        |

...
`.ai-memory/memory/v2/plan36/40-token-map.md` with a table plus a "conflicts" section listing tokens whose v3 name collides with existing shadcn tokens; note resolution (rename, override, drop).

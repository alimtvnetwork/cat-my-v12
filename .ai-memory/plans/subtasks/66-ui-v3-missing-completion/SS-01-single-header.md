...
5. Close `.ai-memory/issues/22-duplicate-header-still-present.md` and `.ai-memory/issues/18-header-duplicated-control-automation.md` with the screenshot pair.

...
- `.ai-memory/memory/v2/01-ranked-backlog.md:33` — Rank 2 acceptance criteria.
...
- `02-spec/21-app/66-v2-vendor-discovery.md`, `02-spec/21-app/67-v2-discovery-contract.md` — discovery contract.
- `02-spec/21-app/40-error-manage.md` — check whether `E_CFG_UNKNOWN_DEVICE` is registered.
...
- `.ai-memory/issues/01-spec-21-blind-ai-readiness.md` — check if still open.

## Output

`.ai-memory/memory/v2/plan26/00-baseline-gap.md` with a table: Acceptance criterion | Status (SHIPPED / PARTIAL / MISSING) | Evidence path:line | Plan 26 step that closes it.
...
- Issue 01 status resolved (kept open with note, or closed with pointer to `02-spec/25-app-audit/99-signoff.md`).

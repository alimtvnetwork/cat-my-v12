...
1. `02-spec/21-app/66-v2-vendor-discovery.md`
...
2. `02-spec/21-app/67-v2-discovery-contract.md`
...
3. `02-spec/21-app/40-error-manage.md`
...
- `E_CFG_UNKNOWN_DEVICE` shows up exactly once in `02-spec/21-app/40-error-manage.md` with the required fields.

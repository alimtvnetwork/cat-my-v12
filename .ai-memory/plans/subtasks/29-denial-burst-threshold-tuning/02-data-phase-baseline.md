...
Sample size question in `02-spec/21-app/shell/24-open-questions.md` still OPEN. The fixture is not the answer; the answer comes from the real 90-day export in the next turn. Documented so Step B does not accidentally close it early.

...
Implement the shared domain layer and UI mode switch as specified in section 1 of `.ai-memory/plans/pending/01-pattern-search-spec.md`.

## 2. Instructions

1. Review `.ai-memory/plans/pending/01-pattern-search-spec.md` Section 1.

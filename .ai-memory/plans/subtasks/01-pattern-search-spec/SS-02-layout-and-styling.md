...
Implement the core visual system, CSS tokens, and layout shell for the Standard UI as specified in Section 2 and 3 of `.ai-memory/plans/pending/01-pattern-search-spec.md`.

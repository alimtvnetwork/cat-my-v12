...
Implement the Search Region Tab containing the Search Region, Mask Region layers, and Image Region blocks as specified in Section 8 of `.ai-memory/plans/pending/01-pattern-search-spec.md`.

...
Finalize integration, bidirectional syncing, and ensure the Modern UI consumes the shared domain layer without degradation as specified in Sections 10 and 11 of `.ai-memory/plans/pending/01-pattern-search-spec.md`.

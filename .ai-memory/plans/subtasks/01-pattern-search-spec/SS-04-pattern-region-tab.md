...
Implement the Tool Panel structure, the Pattern Region Tab, and Detection Conditions as specified in Sections 6 and 7 of `.ai-memory/plans/pending/01-pattern-search-spec.md`.

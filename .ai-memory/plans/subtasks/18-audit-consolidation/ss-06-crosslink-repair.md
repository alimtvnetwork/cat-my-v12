...
For every hit, rewrite the link to `latest/` or the current `02-spec/21-app/61-67` anchor. Do not leave dead anchors. Re-run until zero hits outside intentionally historical changelog and release-note prose.

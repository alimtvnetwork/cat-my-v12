...
- `02-spec/25-app-audit/00-rubric.md` now exists at the audit top level.
- `02-spec/25-app-audit/00-scope.md` now exists at the audit top level.
- Rubric weights sum to 100: 25 + 25 + 20 + 15 + 10 + 5.
- Scope points v2 work to `02-spec/21-app/61-v2-scope.md` through `02-spec/21-app/67-v2-discovery-contract.md`; it does not depend on the removed standalone v2 folder.

...
**Rules Violated:** `02-spec/02-coding-guidelines/01-cross-language/02-boolean-principles/01-naming-prefixes.md`, `.ai-memory/coding-guidelines.md` § Boolean Naming

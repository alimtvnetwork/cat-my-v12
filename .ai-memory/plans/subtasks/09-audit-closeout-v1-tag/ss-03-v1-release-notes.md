...
5. `.ai-memory/memory/audit/99-audit-report.v1.0.0.md` — copy of v0.105 report with `Ship Status: READY` frontmatter.

## Copy rules

- No emojis (Core memory rule).
- Do NOT call this a Keyence product (IP guardrail: `.ai-memory/02-spec/commands/02-ip-guardrail.md`).

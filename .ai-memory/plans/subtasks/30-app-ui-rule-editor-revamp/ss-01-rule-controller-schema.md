...
Defines the typed shape a `RuleLayer` carries and the panel each `kind` renders. This lives in `02-spec/24-app-ui-design-system/04-rule-editor/03-rule-controller.md` once the spec sweep lands.

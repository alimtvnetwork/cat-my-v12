...
Rules for the full-bleed image workspace and the drawing/selection/manipulation states. Anchors `02-spec/24-app-ui-design-system/04-rule-editor/02-canvas.md`.

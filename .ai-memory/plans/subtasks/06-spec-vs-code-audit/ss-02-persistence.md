...
Audit `02-spec/21-app/20-*.md`..`23-*.md`, `26-migrations.md`, plus `02-spec/04-database-conventions/**` and `02-spec/23-app-db/**` against:
...
Findings appended to `.ai-memory/memory/audit/22-persistence.md` with Severity/Impact and proposed correction per finding.

...
Audit `02-spec/21-app/09-runtime-processes.md` through `02-spec/21-app/16-*.md` against:
...
Findings appended to `.ai-memory/memory/audit/21-runtime.md` with Severity/Impact and proposed correction per finding.

...
Source of truth: `.ai-memory/plans/subtasks/02-control-automation-redesign/ss-09-elevation-focus.md`.

## Files read

- `.ai-memory/plans/pending/31-plan-02-remaining-hmi-primitives.md:43-54` for Steps 8-19 and Step 10 scope.
- `.ai-memory/plans/subtasks/02-control-automation-redesign/ss-09-elevation-focus.md:1-26` for the locked focus and elevation requirements.

...
Source of truth: `.ai-memory/plans/subtasks/02-control-automation-redesign/ss-05-nav-lock.md`.

## Files read

- `.ai-memory/plans/pending/31-plan-02-remaining-hmi-primitives.md:44` (Step 9)
- `.ai-memory/plans/subtasks/02-control-automation-redesign/ss-05-nav-lock.md:1-30`

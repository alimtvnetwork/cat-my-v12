...
Source of truth: `.ai-memory/plans/subtasks/02-control-automation-redesign/ss-04-routes.md`.

## Files read

- `.ai-memory/plans/pending/31-plan-02-remaining-hmi-primitives.md:37-42`
- `.ai-memory/plans/subtasks/02-control-automation-redesign/ss-04-routes.md:7-30`
- `.ai-memory/plans/subtasks/31-plan-02-remaining-hmi-primitives/notes-step-07-ss03-inventory.md:18-31`
- `02-spec/coding-guidelines/typescript.md:14-51`
- `.ai-memory/memory/index.md:1-27`
- `.ai-memory/memory/04-design-system.md:1-24`
- `.ai-memory/memory/07-lovable-folder-guide.md:34-50`
...
`test -f .ai-memory/plans/subtasks/31-plan-02-remaining-hmi-primitives/notes-step-08-ss04-route-diff.md` returned `missing`.

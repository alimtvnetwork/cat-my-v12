...
- `02-spec/coding-guidelines/typescript.md:16-20`, token rule.
...
- `.ai-memory/plans/subtasks/31-plan-02-remaining-hmi-primitives/acceptance.md:17-36`, current SS-02 and cross-cutting acceptance rows.
- `.ai-memory/plans/subtasks/31-plan-02-remaining-hmi-primitives/notes-step-11-linter-scripts.md:27-41`, named verification gates.

Before signal:

- `test -f .ai-memory/plans/subtasks/31-plan-02-remaining-hmi-primitives/hardcoded-hits.md`: missing.
...
- Created `.ai-memory/plans/subtasks/31-plan-02-remaining-hmi-primitives/hardcoded-hits.md` with one row for each remaining raw-color line and a bootstrap-fallback justification.

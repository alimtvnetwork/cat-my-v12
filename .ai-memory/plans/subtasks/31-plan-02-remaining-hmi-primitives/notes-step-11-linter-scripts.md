...
- `.ai-memory/plans/subtasks/02-control-automation-redesign/ss-10-token-verify.md:1-24`
- `.ai-memory/plans/subtasks/02-control-automation-redesign/ss-11-token-compile.md:1-4`
- `.ai-memory/plans/pending/31-plan-02-remaining-hmi-primitives.md:43` (Step 11 scope)

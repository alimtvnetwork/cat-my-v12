...
5. Back-link row to `02-spec/21-app/68-v2-vendor-sdk-contract.md` and `02-spec/21-app/52-sdk-facade-pattern.md`.
...
`grep -c "## Facade Binding" 02-spec/21-app/6{3,4,5}-*.md` returns 1 for each file. Domain object table row count >= 4 per facade.

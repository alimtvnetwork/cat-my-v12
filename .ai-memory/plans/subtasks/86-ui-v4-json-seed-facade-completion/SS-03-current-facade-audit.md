...
`.ai-memory/pending-facades/`: 01-rule, 02-category-alias, 03-mic-settings, 04-camera-setting-wrap, 05-project-v4, 06-swatches, README. **Gaps for Plan 86:** need TODOs for image-samples, presets (property panes), commands (palette), empty-states, error-scenarios, settings — each will become a fake facade during Steps 11-24.

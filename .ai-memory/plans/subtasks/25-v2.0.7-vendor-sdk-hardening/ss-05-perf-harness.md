...
Measure end-to-end capture throughput and prove the 77 fps SLO named in `02-spec/21-app/50-capture-modules.md`.
...
4. Pin results to `.ai-memory/memory/v2/plan25/05-perf-run-<date>.md`.

## Output

Harness script + fixture manifest + at least one recorded run per adapter. Result table copied into `02-spec/25-app-audit/latest/` on Step 9.

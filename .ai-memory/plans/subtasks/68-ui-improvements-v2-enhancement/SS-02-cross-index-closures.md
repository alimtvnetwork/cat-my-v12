...
| I-BE-02 | pending  | none                        | -                                      | mermaid DB diagrams under `02-spec/23-app-db/` not authored                                               |
...
| I-MT-02 | closed   | plan 66 s2                  | v3.399.0                               | `.ai-memory/ambiguity-questions/02-ui-v3-open-questions.md`                                              |
...
- Adjacent done plans: `.ai-memory/plans/done/{24,30,31,34,37,42,43,45,64,65,66,67}-*.md`.
- `.ai-memory/plans/done/subtasks-42-rule-conditions-and-validation-order/`.
- `RELEASE_NOTES.md`, `CHANGELOG.md`.
- `02-spec/24-app-ui-design-system/97b-ui-acceptance-checklist.md`.
- `02-spec/24-app-ui-design-system/98-changelog.md`.
...
- Every `closer: none` row is explicit.
  \*\*\* Add File: .ai-memory/plans/subtasks/68-ui-improvements-v2-enhancement/SS-03-classify-and-flag-ambiguities.md
...
- `pending`: no closer, but a matching plan under `.ai-memory/plans/pending/` owns the work.
...
- Every ambiguity ends with a "Decision needed:" line.
  \*\*\* Add File: .ai-memory/plans/subtasks/68-ui-improvements-v2-enhancement/SS-04-target-filename-decision.md
...
1. Placed AFTER the current last file in `02-spec/24-app-ui-design-system/`.
...
Filename: `02-spec/24-app-ui-design-system/99d-ui-improvements-v2-enhancement.md`.

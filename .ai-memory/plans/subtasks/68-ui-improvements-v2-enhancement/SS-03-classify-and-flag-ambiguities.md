...
- `02-spec/24-app-ui-design-system/97b-ui-acceptance-checklist.md` DEC-01..DEC-08 (still open P0 gates).
- `.ai-memory/plans/pending/` scan for owners of unclosed items.
...
- I-BE-02 (mermaid DB diagrams under `02-spec/23-app-db/`) - no pending owner.

...
- `02-spec/24-app-ui-design-system/09-UI-improvements-v2.md` — the original V2 backlog (source of truth for item wording).
- `.ai-memory/plans/done/66-ui-v3-missing-completion.md` — first execution wave (extracts step titles, not step bodies).
- `.ai-memory/plans/done/67-ui-fluid-modern-v2-v3-completion.md` — 50-step execution wave.
...
```
- [I-01] Drag affordance polish — 02-spec/24/09:L42 ; plan 67 step 3
- [I-02] Header rebuild — 02-spec/24/09:L58 ; plan 67 step 10
```
...
- [I-BE-02] Mermaid DB diagrams under `02-spec/23-app-db/` — spec09 L30 ; origin: spec09
...
- [I-MT-02] Ambiguity questions filed under `.ai-memory/ambiguity-questions/` — spec09 L28 ; origin: spec09

...
Final path: `02-spec/24-app-ui-design-system/99d-ui-improvements-v2-enhancement.md`.

Sibling context (existing tail of `02-spec/24-app-ui-design-system/`):
...
2. Slug ends with `-v2-enhancement`.
3. `rg -l v2 02-spec/24-app-ui-design-system/` finds it by filename alone.

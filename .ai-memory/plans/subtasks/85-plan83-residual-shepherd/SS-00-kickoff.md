...
Created `.ai-memory/plans/pending/85-plan83-residual-shepherd.md` with a 20-step ordered slice that maps 1:1 onto Plan 83 residual step numbers, biased toward ship-per-turn units. High-risk rewrites (steps 26-29, 32-36, 42-43, 47-50 of Plan 83) explicitly deferred to a future Plan 86.

## Verification

- `ls .ai-memory/plans/pending/` = 21 (was 20 after Plan 84 closeout).

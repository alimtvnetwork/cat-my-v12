...
Rename every column in `app/core/io/migrations/root/000_init.sql` output from camelCase to PascalCase per `02-spec/04-database-conventions` and audit finding F-76.
...
- `.ai-memory/memory/audit/30-db-conventions.md` rescored ≥ 80.

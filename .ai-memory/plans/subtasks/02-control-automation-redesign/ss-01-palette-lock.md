...
**Decision:** Dark Slate (oklch). Locked 2026-07-09, superseded 2026-07-15 to match shipped `src/styles.css` and 02-spec/24-app-ui-design-system/01-foundations.md (dated 2026-07-14). Rationale in `.ai-memory/plans/subtasks/31-plan-02-remaining-hmi-primitives/notes-step-03-palette-drift.md`.
...
- Spec/24 alignment: `02-spec/24-app-ui-design-system/01-foundations.md` (canvas-bg reuses this hue)

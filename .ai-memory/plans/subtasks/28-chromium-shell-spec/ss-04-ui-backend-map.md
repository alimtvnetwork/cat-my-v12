...
Produce `02-spec/21-app/shell/05-ui-to-backend-map.md`. It must contain one table per UI surface. Columns:
...
- Rows requiring long detail link to a sub-file under `02-spec/21-app/shell/methods/<method>.md`.

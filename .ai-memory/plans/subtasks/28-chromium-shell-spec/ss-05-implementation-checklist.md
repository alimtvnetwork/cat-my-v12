...
Produce `02-spec/21-app/shell/23-implementation-checklist.md`. Ordered, each row has: id, action, files touched, acceptance test, rollback.
...
12. Self-update — bind to `02-spec/14-update/`; simulate upgrade + rollback.

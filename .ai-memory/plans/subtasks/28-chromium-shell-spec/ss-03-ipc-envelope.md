...
Produce `02-spec/21-app/shell/04-ipc-contract.md`. Must specify:
...
- Error taxonomy: reference `../12-error-taxonomy.md`; every error MUST carry an `E_*` code from `02-spec/03-error-manage/`.
...
- Schema source of truth: JSON Schema under `02-spec/21-app/shell/schemas/ipc/*.json` (files to be created during implementation).

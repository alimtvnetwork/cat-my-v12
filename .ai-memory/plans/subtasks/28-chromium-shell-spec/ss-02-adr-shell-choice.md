...
Produce `02-spec/21-app/shell/01-adr-shell-choice.md` using the ADR template already used in this repo. Required content:

- Status: Proposed → Accepted (with date).
- Context: Python-heavy backend, Node/Next UI, need for signed desktop delivery, offline-first, self-update per `02-spec/14-update/`.
...
- Links: `../10-app-overview.md`, `../11-system-context.md`, `02-spec/14-update/`.

...
Write these files under `02-spec/21-app/` before touching any UI or code.

## Files to add

1. `02-spec/21-app/40-rule-condition-model.md`
...
2. `02-spec/21-app/41-color-condition.md`
   - Color modes:
...
3. `02-spec/21-app/42-validation-order.md`
...
4. `02-spec/21-app/43-rule-controller-ui.md`
...
5. `02-spec/21-app/99-consistency-report.md` addendum entry linking to

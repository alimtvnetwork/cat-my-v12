...
Parent plan: `.ai-memory/plans/pending/16-rule-bundle-import-export-spec.md`
Parent spec: `02-spec/21-app/70-rule-bundle-import-export.md` §70.7

Precondition: caller holds `RuleBundleExport` feature (see `02-spec/21-app/60-licensing.md`). Format is chosen by caller: `BundleFormatSqlite` or `BundleFormatJson`.

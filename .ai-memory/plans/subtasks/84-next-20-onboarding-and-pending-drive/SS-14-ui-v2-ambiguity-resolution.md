...
Source: `.ai-memory/ambiguity-questions/01-ui-v2-open-questions.md`
...
- Q21 Deferred documentation task; not blocking code. Assets folder `02-spec/24-app-ui-design-system/assets/` remains empty until user attaches.

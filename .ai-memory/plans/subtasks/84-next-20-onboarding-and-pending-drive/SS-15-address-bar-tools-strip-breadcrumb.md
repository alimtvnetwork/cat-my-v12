...
- Renamed `.ai-memory/issues/31-duplicate-breadcrumb.md` → `closed-31-duplicate-breadcrumb.md`.
- Renamed `.ai-memory/issues/32-tools-strip-between-header-and-canvas.md` → `closed-32-tools-strip-between-header-and-canvas.md`.
- No src edits.

...
Audit `02-spec/21-app/09-runtime-processes.md`..`16-*.md` against:
...
5. Dispatcher lifecycle atomic transitions still match `02-spec/21-app/13-*` state chart.
6. New `E_HW_*` codes present in error taxonomy.

## Output

Findings → `.ai-memory/memory/audit/v1.15.0/20-runtime.md` with Severity/Impact/Proposed-correction.

...
Audit `02-spec/21-app/27-security.md` (or equivalent) against post-v1 modules:
...
Findings → `.ai-memory/memory/audit/v1.15.0/27-security.md` with Severity/Impact/Proposed-correction.

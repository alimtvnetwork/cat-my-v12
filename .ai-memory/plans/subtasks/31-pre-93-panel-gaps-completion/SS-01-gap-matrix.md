...
- Spec source of truth: `02-spec/24-app-ui-design-system/05-rule-controller.md` §"Kind x visible-fields matrix" (lines 34-49) and `02-layout.md` §"Lighting drawer" (lines 74-114) + referenced `subtasks/30-app-ui-rule-editor-revamp/ss-05-lighting-controls.md`.

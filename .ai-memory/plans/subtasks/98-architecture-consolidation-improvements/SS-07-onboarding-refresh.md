...
**Changed Files:** `.ai-memory/what-to-read.md`, `README.md`, `.ai-memory/suggestions.md`, `.ai-memory/plans/pending/98-architecture-consolidation-improvements.md` (moved to `completed/`), `.ai-memory/02-spec/tasks/98-architecture-consolidation-improvements.md`, `.ai-memory/plans/index.md`
...
`.ai-memory/what-to-read.md` is the authoritative onboarding map but does not link:
...
3. Link `.ai-memory/memory/features/facade-migration-policy.md` (SS-04)
4. Link `02-spec/21-app/shell/03-implementation-status.md` (SS-02)
...
### Optional: `.ai-memory/suggestions.md`
...
4. Write closeout memo `.ai-memory/memory/v2/plan98/00-closeout.md` when all SS complete
...
- [ ] Update `.ai-memory/plans/index.md`

...
- `02-spec/21-app/shell/03-implementation-status.md`
...
- `02-spec/21-app/shell/02-runtime-architecture.md` — Tauri host; code uses Chromium MV3
...
Add **`02-spec/21-app/shell/03-implementation-status.md`** (new):
...
Add one paragraph to `02-spec/03-error-manage/02-error-architecture/05-response-envelope/` or CHANGELOG pointer:
...
- Choosing Tauri vs CEF (defer to `02-spec/22-app-issues/` AI-01 resolution)

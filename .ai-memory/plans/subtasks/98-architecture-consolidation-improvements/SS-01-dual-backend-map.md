...
4. Cross-check against `02-spec/24-app-ui-design-system/20-backend-endpoint-map.md`
...
- [ ] Reviewed against `02-spec/21-app/11-system-context.md` — discrepancies listed, not hidden

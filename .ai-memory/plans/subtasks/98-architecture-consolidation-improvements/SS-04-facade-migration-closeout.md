...
- `.ai-memory/memory/features/facade-migration-policy.md`
- `.ai-memory/pending-facades/README.md`
  **Parallel:** Yes (Wave 1)  
  **Related:** Plan 86, `.ai-memory/pending-facades/`
...
Create **`.ai-memory/memory/features/facade-migration-policy.md`**:

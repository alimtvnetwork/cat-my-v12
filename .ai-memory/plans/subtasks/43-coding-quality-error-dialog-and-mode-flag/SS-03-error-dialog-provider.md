...
Update `02-spec/03-error-manage/02-error-architecture/04-error-modal/02-react-components.md` to describe the new provider, mode gating, and PascalCase names.

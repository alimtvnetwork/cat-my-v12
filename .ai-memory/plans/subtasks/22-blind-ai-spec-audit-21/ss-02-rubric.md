...
10. **BlindAiReadiness** — final subjective 0-10: could a weak model, given ONLY `02-spec/`, implement this?
...
`02-spec/25-app-audit/01-rubric.md` mirrors this content verbatim so the blind AI does not need this plan file to grade itself later.

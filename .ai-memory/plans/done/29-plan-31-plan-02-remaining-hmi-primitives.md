...
Sources scanned: .ai-memory/plans/pending/28-30, .ai-memory/plans/subtasks/02-_,
02-spec/24-app-ui-design-system, 02-spec/21-app/30-ui-overview.md, src/components/hmi/_,
src/routes/\*.

Related pending plans (not merged here, tracked separately):

- .ai-memory/plans/pending/29-denial-burst-threshold-tuning.md
- .ai-memory/plans/pending/30-app-ui-rule-editor-revamp.md
- .ai-memory/plans/pending/28-chromium-shell-spec.md (also in completed/, needs dedupe)

Coding guidelines consulted: .ai-memory/memory/01-code-red.md,
02-spec/coding-guidelines/typescript.md, 02-spec/03-error-manage/,
02-spec/24-app-ui-design-system/07-errors-logging.md.

## Steps

1. Dedupe 28-chromium-shell-spec.md: confirm completed copy is authoritative, remove pending duplicate.
2. Read 02-spec/24-app-ui-design-system/01-foundations.md and record delta vs current src/styles.css palette.
3. Read .ai-memory/plans/subtasks/02-control-automation-redesign/ss-01-palette-lock.md, confirm --ca-\* tokens present in styles.css.
...
39. Update 02-spec/24-app-ui-design-system/97-acceptance-criteria.md rows for R-\* covering new primitives.
40. Update 02-spec/24-app-ui-design-system/00-overview.md hardcoded-hits table with post-sweep counts.
41. Update .ai-memory/plans/subtasks/02-control-automation-redesign/ss-03-component-inventory.md status to completed.
...
45. Update .ai-memory/memory/04-design-system.md if primitive list changed.
...
- ss-01-palette-options, ss-01-palette-lock, ss-02-tokens-oklch, ss-02-type-stack-lock, ss-03-component-inventory, ss-04-routes, ss-05-nav-lock (final verification), ss-09-elevation-focus, ss-10-token-verify, ss-11-token-compile from .ai-memory/plans/subtasks/02-control-automation-redesign/.

...
5. Write `.ai-memory/memory/v2/plan35/35-slice-1-closeout.md`: landed gap, commits, remaining gap count from `25-read-phase-summary.md`, next-slice pointer. Do not move Plan 35 to completed; remaining gaps stay tracked.

...
- Command: `.ai-memory/02-spec/commands/09-home-hub-top-nav.md`
- Issue: `.ai-memory/issues/10-home-missing-projects-and-top-nav.md`
...
28. Update `.ai-memory/02-spec/commands/09-home-hub-top-nav.md` with a "Landed in Plan 34" footnote and link to this plan.
29. Update `.ai-memory/issues/10-home-missing-projects-and-top-nav.md` status to `resolved` with the fixing-plan reference.
30. Move this plan file: `mv .ai-memory/plans/pending/34-home-hub-projects-rulesets.md .ai-memory/plans/done/34-home-hub-projects-rulesets.md` and flip `Status:` frontmatter to `completed`.

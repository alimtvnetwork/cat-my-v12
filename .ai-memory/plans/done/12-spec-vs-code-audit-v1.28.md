...
- Command: `.ai-memory/02-spec/commands/05-spec-vs-code-audit-30step.md`
...
2. Enumerate every file under `02-spec/21-app/**`, app DB specs, and UI design specs into a spec inventory list.
...
29. Refresh `.ai-memory/memory/audit/index.md` and write `02-spec/22-app-issues/consistency-1.28.0-full.md`.
30. Mark plan complete: flip `Status:` to `completed` and `mv .ai-memory/plans/pending/12-spec-vs-code-audit-v1.28.md .ai-memory/plans/done/`.
...
- Plan file lives in `.ai-memory/plans/done/` at end; not duplicated.

## Appended from prior pending tasks

None. `.ai-memory/plans/pending/` was empty prior to this file.

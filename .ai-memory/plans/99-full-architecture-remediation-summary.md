...
Full plan: `.ai-memory/plans/pending/99-full-architecture-remediation.md`
Spec: `.ai-memory/02-spec/tasks/99-full-architecture-remediation.md`
...
| 159-163    | Sweep `02-spec/`, `.ai-memory/`, root `README.md` for `BE/routes/` references; fix each |
...
| Step Range | What Happens                                                                                |
| ---------- | ------------------------------------------------------------------------------------------- |
| 171        | Update `02-spec/21-app/backend-implementation-request-v1.md` if stale                          |
...
- `.ai-memory/plans/index.md` — Plan 99 registered
- `.ai-memory/memory/index.md`, `overview.md`, `06-spec-map.md`
...
1. **Read before coding:** `.ai-memory/coding-guidelines.md`, `.ai-memory/strictly-avoid.md`, `.ai-memory/memory/13-avoid-blind-mass-refactors.md`
...
7. **If a step produces unexpected output**, file it as an issue in `.ai-memory/issues/` before continuing. Do not guess past it.

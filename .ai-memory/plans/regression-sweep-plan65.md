...
- Consolidate drift keys (`workspace-layout:v1`, `palette.layout.v1`, `ca.recent-projects.v1`, `ca:projects:v1`, `ca.favorites`) into `StorageKey` per `.ai-memory/plans/layout-persistence-audit.md`.

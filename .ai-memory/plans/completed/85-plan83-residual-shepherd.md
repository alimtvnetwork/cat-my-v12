...
19. **Plan 83 step 46 — Verification sweep**: `tsgo --noEmit`, full
    ...
    `.ai-memory/plans/subtasks/85-plan83-residual-shepherd/verification.md`.
20. **Plan 85 closeout**: flip Plan 85 to completed, move to
    `.ai-memory/plans/completed/`. Deferred to a Plan 86 shepherd:
...
- After each step, subtask note under
  `.ai-memory/plans/subtasks/85-plan83-residual-shepherd/SS-NN.md`

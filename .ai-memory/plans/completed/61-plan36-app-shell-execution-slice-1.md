...
5. Append the shell contract clause to the spec app-shell row referencing `30-slice-1.md`; write `.ai-memory/memory/v2/plan36/35-slice-1-closeout.md`: landed gap, commits, remaining gap count, next-slice pointer. Plan 36 stays pending.

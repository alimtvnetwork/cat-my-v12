...
1. Read `15-v3-inventory.md` + `20-target-matrix.md`; write `.ai-memory/memory/v2/plan36/50-nav-sidebar-scope.md` with source paths, target paths, contract (nav slot + sidebar responsive behavior), keyboard shortcuts, and rollback. See ./subtasks/63-plan36-nav-sidebar-port/SS-01-nav-sidebar-scope.md.
...
5. Update spec app-shell row with nav + sidebar contract clauses referencing `50-nav-sidebar-scope.md`; write `.ai-memory/memory/v2/plan36/55-nav-sidebar-closeout.md` with landed gaps, remaining gap count, next-slice pointer. Plan 36 stays pending.

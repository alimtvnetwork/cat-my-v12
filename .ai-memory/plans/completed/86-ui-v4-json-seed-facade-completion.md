...
Captured command: `.ai-memory/02-spec/commands/37-json-seedable-config-facade-ui.md`.
Captured issue: `.ai-memory/issues/35-ui-seeding-values-not-complete.md`.

## Steps

1. Read `.ai-memory/plans/pending/79-ui-improvements-v4.md`, `.ai-memory/plans/pending/80-ui-improvements-v4-polish.md`, `.ai-memory/plans/pending/82-plan100-ui-v4-100steps.md`, and `02-spec/21-app/53-ui-improvements-v4.md` end to end, then write a seed-surface matrix. See ./subtasks/86-ui-v4-json-seed-facade-completion/SS-01-read-synthesis.md.
2. Read `.ai-memory/memory/features/facade-and-seed.md`, `.ai-memory/02-spec/commands/35-seed-fixtures-per-screen.md`, `.ai-memory/02-spec/commands/37-json-seedable-config-facade-ui.md`, and `.ai-memory/issues/35-ui-seeding-values-not-complete.md`, then append their constraints to the matrix.
...
45. Update `02-spec/21-app/53-ui-improvements-v4.md` with the finalized JSON seedable config and facade API contract.
46. Update `.ai-memory/memory/features/facade-and-seed.md` and `.ai-memory/memory/index.md` with the new canonical seed rule if the implementation changes the durable project rule.
47. Close `.ai-memory/issues/35-ui-seeding-values-not-complete.md` only after every target UI surface has a populated seeded test path.
...
50. Move `.ai-memory/plans/pending/86-ui-v4-json-seed-facade-completion.md` to `.ai-memory/plans/completed/86-ui-v4-json-seed-facade-completion.md` and flip `Status: pending` to `Status: completed`.

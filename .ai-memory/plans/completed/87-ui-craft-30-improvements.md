...
Related commands: `.ai-memory/02-spec/commands/31-padding-and-readability-baseline.md`,
...
Related open issues: `.ai-memory/issues/12-ui-overlap-and-density.md`,
`.ai-memory/issues/17-menu-hover-jitter-and-padding.md`,
`.ai-memory/issues/22-duplicate-header-still-present.md`,
`.ai-memory/issues/27-properties-panel-and-badges-crappy.md`,
...
30. Release: bump minor version, update `CHANGELOG.md` and `RELEASE_NOTES.md`, pin the new version in root `README.md`, then move this file to `.ai-memory/plans/completed/87-ui-craft-30-improvements.md` with status flipped.

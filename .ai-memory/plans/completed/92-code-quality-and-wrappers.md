...
5. **Memory Update**: Document these rules in `.ai-memory/memory/` and update `index.md`.

## Steps

1. Create `02-spec/` for Query Wrappers (PHP/Python/TS) detailing the failure logging mechanism.

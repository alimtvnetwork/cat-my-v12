...
- Issue: `.ai-memory/issues/24-setup-rules-form-ui-and-category-picker.md`
...
18. Update `02-spec/24-app-ui-design-system/99d-ui-improvements-v2-enhancement.md` to record the new form + combobox behavior under the Setup section.
19. Bump `package.json`, pin the new version in `README.md`, append `CHANGELOG.md` and `RELEASE_NOTES.md` entries.
20. Move this plan to `.ai-memory/plans/completed/70-setup-rules-form-and-category-picker.md` and flip `Status:` to `completed`; close issue 24 with a link to the commit range.
...
None. Pending plans 40, 41, 44, 46, 57, 58, 59, and others remain in `.ai-memory/plans/pending/` and are unrelated to this form-UI slice.

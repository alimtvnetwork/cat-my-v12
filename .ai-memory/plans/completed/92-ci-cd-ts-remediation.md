...
- Perform the rigid session memory update in `.ai-memory/` containing root causes, workflow summaries, and strict rules for future iterations.
...
4. `.ai-memory/` folder contains the required updated indices and strictly-avoid files.

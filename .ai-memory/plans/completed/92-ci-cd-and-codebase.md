...
3. **Always use QueryWrappers** for data fetching and RPC to automatically log failures according to `02-spec/03-error-manage`.
4. Ensure all new components and routes are properly mapped in `02-spec/21-app/shell/05-ui-to-backend-map.md`.

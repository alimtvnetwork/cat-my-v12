...
364. **Write V4 UI Developer Guide**
     ...
     - **How**: `02-spec/02-coding-guidelines/04-v4-patterns.md`.
     - **Agents**: 1 (Documentation).
...
386. **Update `.ai-memory/plans/index.md` to "Done"**
     - **What**: Move Plan 99 to completed section.
     - **How**: Markdown edit.
     - **Agents**: 1 (Manager).
     - **Guidelines**: Process.
387. **Archive Plan 99 files**
     - **What**: Move the 3 part files to `.ai-memory/plans/done/`.
     - **How**: File system move.
     - **Agents**: 1 (Manager).
     - **Guidelines**: Organization.
388. **Update `.ai-memory/memory/index.md`**

...
**Wave 2:** SS-05, SS-06  
**Wave 3:** SS-07  
**Closeout:** Update this file status → completed; write `.ai-memory/memory/v2/plan98/00-closeout.md`
...
- [x] `.ai-memory/what-to-read.md` links architecture observations + runtime map (SS-07)
...
- `.ai-memory/pending-facades/` — remaining SDK/domain facades

...
Related open issues: `.ai-memory/issues/09-setup-ui-not-modern.md`, `.ai-memory/issues/12-ui-overlap-and-density.md`, `.ai-memory/issues/17-menu-hover-jitter-and-padding.md`, `.ai-memory/issues/19-rules-editor-program-panel-and-layer-arrow.md`, `.ai-memory/issues/20-tools-collapse-chevron-unprofessional.md`, `.ai-memory/issues/24-setup-rules-form-ui-and-category-picker.md`, `.ai-memory/issues/27-properties-panel-and-badges-crappy.md`.
...
None routed into this plan. Prior pending plans (`29`, `35`, `36`, `40`, `41`, `44`, `49`, `50`, `51`, `52`, `58`, `59`, `61`, `62`, `63`, `79`, `80`) remain in `.ai-memory/plans/pending/` and are tracked independently; this plan is scoped strictly to Settings + Rules + adjacent-page polish.

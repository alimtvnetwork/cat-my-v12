...
`02-spec/21-app/53-ui-improvements-v4-assets/plan82/upload-71.png` ...
...
`.ai-memory/coding-guidelines.md`. Every user-visible failure MUST route through
...
Scan of `.ai-memory/plans/pending/` shows the following older pending plans NOT

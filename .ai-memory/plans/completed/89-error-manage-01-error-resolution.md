...
# Plan 89: Implement `02-spec/03-error-manage/01-error-resolution/` end-to-end
...
Create in `02-spec/03-error-manage/01-error-resolution/app-issues/`:
...
Add `02-spec/03-error-manage/01-error-resolution/CHECKLIST.md` with a 6-item gate the agent MUST satisfy before ending any turn that touches error paths:
...
- Log formatter includes a URL to `02-spec/03-error-manage/01-error-resolution/02-debugging-cheat-sheet.md` on every 5xx envelope in dev mode.
...
- `02-spec/03-error-manage/01-error-resolution/app-issues/` contains a dated retro for every fix landed since Plan 88 started.

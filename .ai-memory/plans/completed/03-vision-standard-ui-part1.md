...
1. **Analyze `ProjectEditorSections.tsx`**
   ...
   - **Agents**: 1 (Research).
   - **Guidelines**: Adhere to `02-spec/02-coding-guidelines/00-overview.md` (components < 100 lines).
...
7. **Analyze `src/routes/__root.tsx`**
   ...
   - **Agents**: 1 (Research).
   - **Guidelines**: Adhere to `02-spec/02-coding-guidelines`.
...
22. **Document Canonical Rule Engine**
    ...
    - **How**: Write `02-spec/21-app/canonical-engine.md`.
    - **Agents**: 1 (Backend).
...
50. **Review Phase 2 against Spec**
    ...
    - **How**: Manual cross-check with `02-spec/21-app/53-ui-improvements-v4.md`.
    - **Agents**: 1 (Reviewer).

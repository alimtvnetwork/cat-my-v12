...
Agents executing this plan should focus on architectural integrity, ensuring that prop drilling is minimized and state is managed appropriately when splitting components. Follow the `02-spec/02-coding-guidelines/` very strictly.

...
- Command: `.ai-memory/02-spec/commands/16-keyboard-a11y-dnd-rules.md`
- Command: `.ai-memory/02-spec/commands/17-code-quality-enums-constants.md`

Applicable guideline sources (all present, all in scope):

- `.ai-memory/coding-guidelines.md`
- `02-spec/02-coding-guidelines/**` (esp. `02-typescript/`, `11-security/`)
...
1. Read every file in `02-spec/02-coding-guidelines/02-typescript/` and
   `02-spec/03-error-manage/` end-to-end; note rules that constrain this
   plan.
2. Read `.ai-memory/coding-guidelines.md` and align its
...
- Docs: the three guideline files listed in SS-03 exist and are
  referenced from `.ai-memory/coding-guidelines.md`.

## Appended from prior pending tasks

Scanned `.ai-memory/plans/pending/`. The following plans remain open and

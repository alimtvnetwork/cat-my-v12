...
| ---------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------ |
| **Any contributor (human or AI)**  | [`.ai-memory/what-to-read.md`](./what-to-read.md) — authoritative onboarding map                                                                         |
| **New to the product**             | This file (overview) → root [`README.md`](../README.md)                                                                                                |
| **About to write code**            | [`.ai-memory/ai-improvement-guidelines.md`](./ai-improvement-guidelines.md) + [`.ai-memory/coding-guidelines.md`](./coding-guidelines.md)                  |
...
| **Looking for active work**        | [`.ai-memory/plans/index.md`](./plans/index.md)                                                                                                          |
...
When a **Task** is running, four Python processes cooperate (see `02-spec/21-app/12-runtime-processes.md`):
...
| [`02-spec/`](../spec/)                     | Markdown                                                   | Source-of-truth specifications (~1900 files)                  |
| [`.ai-memory/`](./)                       | Markdown                                                   | Plans, memory, AI guidelines, prompts                         |
...
Legacy Zustand stores coexist with profile-scoped v2 facades via `useFacadeOrStore`. Policy: [`.ai-memory/memory/features/facade-migration-policy.md`](./memory/features/facade-migration-policy.md)
...
- No swallowed catches — spec: [`02-spec/03-error-manage/`](../02-spec/03-error-manage/)
...
- Behavior defined in `02-spec/` before or alongside code
- Serial plans in `.ai-memory/plans/` with subtask evidence
- Closeout memos in `.ai-memory/memory/v2/`
...
| ----------------------------- | ----------------------------------------------------------- | ----------------------------------------------- |
| Shell: Tauri vs Chromium      | Spec says Tauri; code uses MV3 extension                    | `02-spec/21-app/shell/03-implementation-status.md` |
...
Full audit: [`.ai-memory/plans/architecture-and-code-observations.md`](./plans/architecture-and-code-observations.md)  
Improvement plan (completed): [`.ai-memory/plans/completed/98-architecture-consolidation-improvements.md`](./plans/completed/98-architecture-consolidation-improvements.md)  
AI action items: [`.ai-memory/ai-improvement-guidelines.md`](./ai-improvement-guidelines.md)

---

## 9. Recently completed work (high-signal)

Plans marked **completed** in `.ai-memory/plans/completed/` that shaped today's architecture:
...
5. Write closeout to `.ai-memory/memory/v2/` when plan completes
...
| Shell status           | [02-spec/21-app/shell/03-implementation-status.md](../02-spec/21-app/shell/03-implementation-status.md) |
| Product spec           | [02-spec/21-app/10-app-overview.md](../02-spec/21-app/10-app-overview.md)                               |
| Error manage           | [02-spec/03-error-manage/00-overview.md](../02-spec/03-error-manage/00-overview.md)                     |

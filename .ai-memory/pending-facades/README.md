...
Source of truth: `.ai-memory/memory/features/facade-and-seed.md`.
Rulebook: `02-spec/21-app/52-sdk-facade-pattern.md`, `02-spec/21-app/53-ui-improvements-v4.md` section 9.
...
4. Removing a facade fake requires deleting the corresponding TODO (or marking it "completed" then archiving under `.ai-memory/pending-facades/done/`).
...
Memory: .ai-memory/memory/features/facade-and-seed.md

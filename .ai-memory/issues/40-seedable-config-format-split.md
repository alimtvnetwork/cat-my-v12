...
**Related specs:** `02-spec/06-seedable-config-architecture/{00-overview.md,01-fundamentals.md,02-features/00-overview.md}`, `02-spec/21-app/76-cli-log-and-ipc.md` §Seedable config (line 128-130)
**Related memory:** `.ai-memory/memory/26-split-db-cli-cheatsheet.md` §8
...
- `02-spec/06-seedable-config-architecture/01-fundamentals.md` (lines 30-70): `config.seed.json` shape.
- `02-spec/21-app/76-cli-log-and-ipc.md` line 128-130: TOML layer chain.
- `.ai-memory/memory/26-split-db-cli-cheatsheet.md` §8: operative reconciliation used by Plan 90.

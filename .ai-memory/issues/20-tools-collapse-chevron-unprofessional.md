...
Status: closed
Closed: 2026-07-18
Resolution: v3.491.0. `src/styles.css` left-dock override raised `--panel-control-size` 22px→28px and `--panel-icon-size` 13px→16px (plus svg override at :595-598). Playwright measured Tools chevron/close as 28x28 with 16x16 glyph while the dock stays 116px wide, matching Rules panel weight. Memo: `.ai-memory/memory/v2/plan73/20-repro.md`.
Created: 2026-07-17

...
closed - resolved by Plan 70 steps 1-20. See `.ai-memory/plans/completed/70-setup-rules-form-and-category-picker.md`, `CHANGELOG.md` entries v3.444.0 through v3.453.0.

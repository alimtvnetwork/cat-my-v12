...
- Error management (02-spec/03-error-manage) is not yet wired across a real backend boundary.
...
- `BE/` backend project scaffolded per `02-spec/21-app` + coding + error-manage guidelines.
...
- Spec request: `02-spec/21-app/backend-implementation-request-v1.md`

...
**\_ End Patch
\_** Add File: .ai-memory/issues/17-menu-hover-jitter-and-padding.md
...
Plan 64 steps 55-58.
**\_ End Patch
\_** Add File: .ai-memory/issues/18-header-duplicated-control-automation.md
...
Plan 64 steps 51-54.
**\_ End Patch
\_** Add File: .ai-memory/issues/19-rules-editor-program-panel-and-layer-arrow.md
...
Plan 64 steps 59-70.
**\_ End Patch
\_** Add File: .ai-memory/ambiguity-questions/01-ui-v2-open-questions.md
...
Q14. Mermaid diagrams in `02-spec/23-app-db/`: one file per aggregate, or a single master file plus per-aggregate zooms? User asked for both `.mmd` and rendered image; who renders the PNG (CLI in CI, or a manual step)?

...
Created: 2026-07-17
Dispatch summary for user: `.ai-memory/ambiguity-questions/04-plan77-dispatch.md` (Plan 77, 2026-07-18) consolidates every open question here plus Issue 16 blockers into a single reply-ready list.
Parent view: `02-spec/24-app-ui-design-system/99d-ui-improvements-v2-enhancement.md` §4.
Prior lists: `.ai-memory/ambiguity-questions/01-ui-v2-open-questions.md`, `.ai-memory/ambiguity-questions/02-ui-v3-open-questions.md`.
...
Spec 09 L15/L20 says put reference images into "assets folder" with proper names. They live under `02-spec/24-app-ui-design-system/assets/`.

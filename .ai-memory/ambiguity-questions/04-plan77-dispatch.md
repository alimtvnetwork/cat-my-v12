...
Screenshots live under `02-spec/24-app-ui-design-system/assets/`, not `src/assets/`.
...
From `.ai-memory/memory/v2/plan76/13-issue-16-triage.md`. Answer each in one line.

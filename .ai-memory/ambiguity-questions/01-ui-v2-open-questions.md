...
Captured: 2026-07-16
Status: RESOLVED 2026-07-19. See `.ai-memory/plans/subtasks/84-next-20-onboarding-and-pending-drive/SS-14-ui-v2-ambiguity-resolution.md` for decisions and applied changes.
...
Q14. Mermaid in `02-spec/23-app-db/`: one file per aggregate or a master plus per-aggregate zooms? Who renders the PNG?

...
- Output findings with severity + impact to `02-spec/25-app-audit/latest/`, fold useful conclusions into the current audit bundle, and delete processed duplicates.
- Use 30-step plan enforcement (see `.ai-memory/02-spec/commands/01-plan-50-workflow.md` for shared rules; count = 30 here).

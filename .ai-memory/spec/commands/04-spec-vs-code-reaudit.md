...
- Output report to `02-spec/25-app-audit/latest/` with severity + impact per finding, fold useful conclusions into the current audit bundle, and delete processed duplicates.

Applies to: this audit cycle. Extends the rubric in `02-spec/25-app-audit/00-rubric.md`.

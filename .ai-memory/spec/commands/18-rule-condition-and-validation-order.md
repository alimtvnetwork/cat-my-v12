...
- 02-spec/21-app/16-processing-pipeline.md (existing processing model)
- 02-spec/21-app/17-parallelism-guarantees.md (existing parallel guar.)
- .ai-memory/02-spec/commands/10-photoshop-layers-and-drag-drop.md
- .ai-memory/02-spec/commands/17-code-quality-enums-constants.md

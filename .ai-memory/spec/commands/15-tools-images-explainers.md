...
- Output MDs live in `02-spec/24-app-ui-design-system/tools-images/`, one MD per image, plus `INDEX.md`.
- MD shape is defined in `.ai-memory/plans/subtasks/40-tools-images-spec-docs/00-md-template.md`.
...
`.ai-memory/plans/pending/40-tools-images-spec-docs.md`

...
Sequence: 07
Captured: 2026-07-14
Scope: Planning turns that open a new `.ai-memory/plans/pending/XX-*.md`.

## Verbatim

> Start Plan N by selecting the top item from `.ai-memory/memory/v2/01-ranked-backlog.md` and create the corresponding pending plan file.
...
1. Read `.ai-memory/memory/v2/01-ranked-backlog.md` first.
2. Walk the ranked table top-down; skip items whose acceptance criteria are already met (cross-check against `.ai-memory/plans/done/`).

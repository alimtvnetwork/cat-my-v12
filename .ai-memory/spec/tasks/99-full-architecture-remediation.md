...
- Architecture overview generated 2026-08-17: `.ai-memory/brain/*/architecture_overview.md`
- Completed Plan 98 (architecture consolidation) context: `.ai-memory/plans/completed/98-architecture-consolidation-improvements.md`
- Coding guidelines: `.ai-memory/coding-guidelines.md`, `02-spec/02-coding-guidelines/`, `02-spec/03-error-manage/`
- Strictly avoid: `.ai-memory/strictly-avoid.md`
- Memory: `.ai-memory/memory/01-code-red.md`, `.ai-memory/memory/03-error-manage.md`, `.ai-memory/memory/13-avoid-blind-mass-refactors.md`
...
- `.ai-memory/memory/index.md` — update cross-references
- `.ai-memory/memory/07-lovable-folder-guide.md` — update plans lifecycle section
- `02-spec/21-app/` — any file referencing `BE/routes/` or old route filenames
- Root `README.md` — update "run backend" instructions

## Links

- Prior closed plan: `.ai-memory/plans/completed/98-architecture-consolidation-improvements.md`
- Coding guidelines: `.ai-memory/coding-guidelines.md`
- Strictly avoid: `.ai-memory/strictly-avoid.md`
- Memory (blind-mass-refactor rule): `.ai-memory/memory/13-avoid-blind-mass-refactors.md`
- Memory (error architecture): `.ai-memory/memory/03-error-manage.md`

...
- Extracting and storing core vision system terminology in `.ai-memory/memory/vision-system-concepts.md`.
...
- `.ai-memory/memory/vision-system-concepts.md`
- `src/components/vision/*`
- `src/lib/vision/*`
- `.ai-memory/plans/pending/97-vision-system-plan.md`

## Links

- Memory: [.ai-memory/memory/vision-system-concepts.md](file:///d:/work/cat-my/.ai-memory/memory/vision-system-concepts.md)

...
4. **Missing Error Modals:** The application throws raw exceptions or swallows them without leveraging the `spec/03-error-manage` standardized error envelope and UI visualizer.

...
- The `useAppQuery` and `useAppMutation` wrappers were strictly enforced to intercept errors natively and surface `isFail` boolean properties natively (adhering to the *explicit boolean state checks* rule).

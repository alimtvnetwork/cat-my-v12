...
Read this file first. Every entry below is a file in `.lovable/memory/`. For the full onboarding map (folder structure + task-to-files matrix), see [`../what-to-read.md`](../what-to-read.md). For architecture diagrams and product orientation, see [`../overview.md`](../overview.md).

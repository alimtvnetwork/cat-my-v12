...
| [13-avoid-blind-mass-refactors.md](./13-avoid-blind-mass-refactors.md)                                   | Root Cause Analysis: Never blindly replace property names in TS logic without aligning the discriminated union types.           | Before doing mass search-and-replace or large refactors               |

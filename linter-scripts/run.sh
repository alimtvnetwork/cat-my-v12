...
if [ "$SKIP_LINTERS" = false ]; then
  ...
  run_linter "ui-backend-map"        python3 "$SCRIPT_DIR/check-ui-backend-map.py" --strict-schema
  run_linter "ui-backend-map-tests"  python3 "$SCRIPT_DIR/test-check-ui-backend-map.py"
  run_linter "ipc-examples"          python3 "$SCRIPT_DIR/check-ipc-examples.py"
  run_linter "ipc-examples-tests"    python3 "$SCRIPT_DIR/test-check-ipc-examples.py"

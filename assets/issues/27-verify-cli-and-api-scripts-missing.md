...
`.ai-memory/plans/pending/90-worker-and-processing-cli.md` §Verification (L249,
...
- `.ai-memory/plans/pending/90-worker-and-processing-cli.md` L249, L254, L260
...
- `verify-cli-logs.sh`: walk `<APP_LOG_ROOT>/{worker,processing,ps-wrapper}/`,
  ...
  `CorrelationId`, `code` (per 02-spec/03-error-manage envelope logging).

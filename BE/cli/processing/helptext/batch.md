...
- `--results-dir <dir>` (optional): append every `ResultRecord` to
  ...
  `02-spec/21-app/24-results-json.md` §1 (single writer, serialized).
- `--max-workers <int>` (default 1, cap 16): bounded thread fan-out.
  See `02-spec/21-app/17-parallelism-guarantees.md` §7 for why 16 is the
  ceiling.
...
`02-spec/13-generic-cli/18-batch-execution.md` "continue on failure". The
...
`02-spec/21-app/75-processing-cli.md` §Subcommands, §Outputs;
`02-spec/21-app/17-parallelism-guarantees.md` §3, §5;
`02-spec/13-generic-cli/18-batch-execution.md`;
`02-spec/21-app/24-results-json.md` §1.

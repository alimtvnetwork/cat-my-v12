...
export function RuleEditorPanel({
  ...
  return (
    <div className="flex w-full max-w-sm flex-col gap-6 border-l bg-background p-4 shadow-sm">
      <div className="flex flex-col gap-1 border-b pb-4">
        <h3 className="text-sm font-semibold tracking-tight">Rule Parameters</h3>

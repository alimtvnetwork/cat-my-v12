...
import { draw, nextRuleId, logRejected } from "./CanvasViewportRenderer";
  ...
  return (
    <div className="editor-canvas-wrap relative" ref={wrapRef}>
      ...
      <CanvasViewportSampleMenu
        ...
        peekAll={peekAll}
        applyPreviewMode={applyPreviewMode}
        setPeekAll={setPeekAll}
        focusSettingsOpen={focusSettingsOpen}
        setFocusSettingsOpen={setFocusSettingsOpen}
        focusDim={focusDim}
        focusBlur={focusBlur}
        focusIsolate={focusIsolate}
        showThresholds={showThresholds}
        setShowThresholds={setShowThresholds}
        showResults={showResults}
        setShowResults={setShowResults}
        applySpotlightPreset={applySpotlightPreset}
        setFocusDim={setFocusDim}
        setFocusBlur={setFocusBlur}
        setFocusIsolate={setFocusIsolate}

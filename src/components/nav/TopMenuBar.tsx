...
type PanelMap = ReturnType<typeof useWorkspaceLayoutStore.getState>["panels"];
type PanelToggle = (id: string) => void;
...
function collapseFirstOpenPanel(panels: PanelMap, collapseOthers: PanelToggle): void {

...
- Plan 89 (`.ai-memory/plans/pending/89-error-manage-01-error-resolution.md`) adds a mandatory turn-exit checklist (`CHECKLIST.md`) and a lint rule to enforce retro presence.
...
- `.ai-memory/plans/pending/89-error-manage-01-error-resolution.md`

...
**Resolves:** FU-13 from `02-spec/19-main-worker-service/14-rbac-and-status-seed.md` §3.1.
...
Tables in scope today (from `02-spec/19/14-rbac-and-status-seed.md` §2):
...
Input row from `02-spec/19/14-rbac-and-status-seed.md` §3 `RolePageAccess`:
...
- `02-spec/06-seedable-config-architecture/02-features/07-reference-table-seeding.md` — feature this resolver completes.
- `02-spec/06-seedable-config-architecture/02-features/08-config-schema-tables-block.md` — JSON-Schema rejects malformed `@-refs` at lint time.
- `02-spec/06-seedable-config-architecture/02-features/09-config-seed-1.3.0-bump.md` — first seed file that uses `@-refs` (`RolePageAccess`).
- `02-spec/19-main-worker-service/13-error-codes.md` §2.1 + §2.6 — MWS codes raised by failures.
- `02-spec/19-main-worker-service/14-rbac-and-status-seed.md` §3.1 — original syntax declaration.
...
_@-ref resolver v1.0.0 — 2026-05-04 (FU-13 closed)_

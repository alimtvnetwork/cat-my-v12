...
- `02-spec/21-app/40-error-manage.md` Appendix A
- `02-spec/21-app/52-sdk-facade-pattern.md`
- `.ai-memory/memory/09-enums-and-results-shape.md`
...
1. Every boundary error uses one wire code from `02-spec/21-app/40-error-manage.md` Appendix A.

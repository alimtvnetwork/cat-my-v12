...
> (`02-spec/authoring-guideline/VersionSchema.md`). The numeric, convention-
> aligned canonical copy lives at
> [`02-spec/01-spec-authoring-guide/17-version-schema.md`](../01-spec-authoring-guide/17-version-schema.md).
...
| Item                    | Location                                            |
| ----------------------- | --------------------------------------------------- |
| Schema spec (mirror)    | `02-spec/authoring-guideline/VersionSchema.md`         |
| Schema spec (canonical) | `02-spec/01-spec-authoring-guide/17-version-schema.md` |
  ...
  "Authors": [
    {
      ...
      "Urls": ["https://riseup.asia", "https://github.com/alim-ul-karim"],
      "Role": "PrimaryAuthor",
...
- CI/CD Issue 06 — Version Drift (`.ai-memory/cicd-issues/06-version-drift-after-package-bump.md`)

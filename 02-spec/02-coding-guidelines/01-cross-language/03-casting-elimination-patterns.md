...
| Strong Typing Mandate         | `.ai-memory/memories/standards/strong-typing-mandate.md`                                  |
...
_Updated 2026-02-28 — v2.0.0. Added centralized `CastOrFail[T]` utility pattern (§9), "never swallow cast errors" rule (§10), stack skip requirement (§9.4), and test casting patterns (§9.3)._

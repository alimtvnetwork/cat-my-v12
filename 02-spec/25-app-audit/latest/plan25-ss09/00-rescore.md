...
`02-spec/21-app/40-error-manage.md` (313 codes at time of run). All code references across the 7 audited specs resolve.
...
See `02-spec/25-app-audit/latest/plan25-ss09/rescore.json`.

...
Freeze `02-spec/24-app-ui-design-system/` at v1.0 so every subsequent step
...
| ---- | ---------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------- |
| C-01 | All required top-level docs present                                                            | `ls 02-spec/24-app-ui-design-system/*.md` returns 00, 01, 02, 03, 04, 05, 06, 07, 08, 97, 98, 99                                                                                                                 | PASS                   |
| C-02 | Every doc has a heading, no empty files                                                        | `wc -l 02-spec/24-app-ui-design-system/*.md` all > 50                                                                                                                                                            | PASS (min 79, max 154) |
| C-03 | No unresolved TODO/TBD/FIXME/XXX (excluding the changelog Upcoming meta-marker)                | `rg -n "TODO\|TBD\|FIXME\|XXX" 02-spec/24-app-ui-design-system/ \| grep -v '98-changelog.md:.*Upcoming'` empty                                                                                                   | PASS                   |

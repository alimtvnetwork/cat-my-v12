...
- `01-prompts/347-next-task.md` lines 9-49 pinned steps 60-61.
- `02-spec/24-app-ui-design-system/_notes/layout-budget-gate.md` lines 93-109 defined G-LAYOUT-01..03.
- `02-spec/24-app-ui-design-system/_notes/shell-grid-topbar.md` lines 19-110 defined the editor shell and G-SHELL guards.
- `02-spec/24-app-ui-design-system/_notes/right-rail-rule-list.md` lines 88-115 defined rail acceptance and guards.
- `02-spec/24-app-ui-design-system/_notes/status-strip-scaffold.md` lines 96-120 defined status acceptance and guards.

...
**Related issues:** `.ai-memory/issues/18-header-duplicated-control-automation.md`
...
- The duplicated "Control Automation" title area in the current header. Its space is reclaimed by the breadcrumb. See `.ai-memory/issues/18-header-duplicated-control-automation.md`.

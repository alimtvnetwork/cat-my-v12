...
Reuse `animate-fade-in` + `animate-scale-in` from `02-spec/07-design-system/06-motion-transitions.md`.
...
- Every token used by `02-layout` through `08-testing` is defined here or in `02-spec/07-design-system/`.

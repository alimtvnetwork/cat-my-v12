...
Use these exact nouns in UI, spec, DB, and code. The prior term "Recipe" is deprecated and pending removal (see `.ai-memory/ambiguity-questions/01-ui-v2-open-questions.md` Q1).
...
Baseline: `.ai-memory/memory/v2/plan24/00-inventory.md` (pre-sweep raw counts).
Evidence: `.ai-memory/memory/v2/plan24/40-evidence.md`; screens: `.ai-memory/memory/v2/plan24/screens/`.

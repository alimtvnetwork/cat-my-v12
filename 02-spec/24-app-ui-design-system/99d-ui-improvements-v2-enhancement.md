...
created: 2026-07-17
supersedes_view_of:
  - 02-spec/24-app-ui-design-system/09-UI-improvements-v2.md
  - .ai-memory/plans/done/66-ui-v3-missing-completion.md
  - .ai-memory/plans/done/67-ui-fluid-modern-v2-v3-completion.md
...
- Every row uses an `I-XX-NN` id sourced from `.ai-memory/plans/subtasks/68-ui-improvements-v2-enhancement/SS-01-inventory-primary-inputs.md`.
...
Plan 76 audited residual `.ai-memory/issues/` rows tied to V2 chrome. It did not add new V2 rows; the impact on issue tracker state is recorded here so future readers see the reconciliation.
...
| id      | item                     | closer     | version  | verification                                              |
| ------- | ------------------------ | ---------- | -------- | --------------------------------------------------------- |
| I-MT-02 | UI V2 open-questions log | plan 66 s2 | v3.399.0 | `.ai-memory/ambiguity-questions/02-ui-v3-open-questions.md` |
...
Consolidated dispatch: every ambiguity blocking these rows is listed in `.ai-memory/ambiguity-questions/04-plan77-dispatch.md` (Plan 77). Answering that file unblocks all rows below except I-BE-04 (external worker-build gate).
...
| I-BE-02 | Mermaid DB diagrams under `02-spec/23-app-db/`                  | not authored                                                                             | new spec sub-plan (blocked on DEC-04)                                                              |
...
| I-MT-01 | V2 reference images into `src/assets/` with normalized names | screenshots live under `02-spec/24-app-ui-design-system/assets/`, not `src/assets/`         | see Ambiguity A-05                                                                                 |
...
`02-spec/24-app-ui-design-system/09-UI-improvements-v2.md` L26 says "a drop-down button on Home". Home currently uses full workflow cards (v3.432.0).
...
Spec 09 L15, L20 say "keep images as references in this spec and put these images into assets folder and name those properly". Screenshots exist under `02-spec/24-app-ui-design-system/assets/` but not `src/assets/`.
...
- `02-spec/24-app-ui-design-system/09-UI-improvements-v2.md` (original brief)
- `.ai-memory/plans/done/66-ui-v3-missing-completion.md`
- `.ai-memory/plans/done/67-ui-fluid-modern-v2-v3-completion.md`
- `.ai-memory/plans/pending/68-ui-improvements-v2-enhancement.md`
- `.ai-memory/plans/subtasks/68-ui-improvements-v2-enhancement/SS-01..SS-04`

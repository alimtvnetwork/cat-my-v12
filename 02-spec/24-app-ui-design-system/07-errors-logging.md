...
**Cross-linked from:** `02-spec/03-error-manage/03-error-code-registry/01-registry.md` — this file is the authoring source for the codes below; the registry appends them, never forks them.
...
## Codes (register in `02-spec/03-error-manage/03-error-code-registry/`)
...
Append the codes above to `02-spec/03-error-manage/03-error-code-registry/01-registry.md` under a new `## Plan 30 — App UI (rule editor)` section. Do NOT edit `error-codes-master.json` here — the registry file is the source of truth; the JSON is regenerated by `02-spec/03-error-manage/03-error-code-registry/08-linter-scripts/`.

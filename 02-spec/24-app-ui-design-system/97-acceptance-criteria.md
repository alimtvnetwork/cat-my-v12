...
1. Run the corresponding test file (`02-spec/24-app-ui-design-system/08-testing.md` § traceability).
...
| ID           | Source                                                                                                | Rule                                                                                                                                                           |
| ------------ | ----------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| LC-01..LC-12 | `.ai-memory/plans/subtasks/30-app-ui-rule-editor-revamp/ss-05-lighting-controls.md` § Validation matrix | Lighting drawer ranges, defaults, step validation, capability narrowing, apply logging, unavailable-camera surfacing, revert defaults, and preset persistence. |
...
- [ ] All plan 30 files moved from `02-spec/24-app-ui-design-system/_notes/` → `completed/` where applicable.

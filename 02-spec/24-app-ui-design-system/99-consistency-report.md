...
**Version:** 1.0  
**Updated:** 2026-07-14  
**Scope:** `02-spec/24-app-ui-design-system/` files 00..08, 97, 98.  
...
- `02-spec/03-error-manage/03-error-code-registry/01-registry.md` (namespace cross-link)
- `02-spec/spec-index.md` (folder totals)
...
| `02-spec/spec-index.md` App UI section lists 01..08 (9 rows total incl. 00) | PASS   |
| `02-spec/spec-index.md` totals updated 411 → 419                            | PASS   |
...
| Registry cross-link exists in `02-spec/03-error-manage/03-error-code-registry/01-registry.md` explicitly ignoring these prefixes | PASS   |
...
| Check                                                                                                           | Result |
| --------------------------------------------------------------------------------------------------------------- | ------ |
| `06-state-persistence.md` `programs/<id>.json` path unique — not conflicting with any file in `02-spec/23-app-db/` | PASS   |
...
Executed at 2026-07-16 across `src/`, `02-spec/`, and `.ai-memory/`:
...
A linter script `linter-scripts/check-no-recipe.py` (to be added in Plan 64 step 51 preparation) will fail the build when `\brecipe(s)?\b` appears in any file except `02-spec/24-app-ui-design-system/98-changelog.md` (historical) and `_notes/recipe-residue.md` (justified exceptions).

### Pass criteria

- Zero grep hits under `src/`.
- Zero grep hits under `02-spec/` except the two exempt paths above.

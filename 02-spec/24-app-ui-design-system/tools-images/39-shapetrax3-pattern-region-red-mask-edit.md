---
Source: assets/tools-images/39-shapetrax3-pattern-region-red-mask-edit.jpg
Screen: Shapetrax3 pattern region red mask edit
Related-Spec: 03-canvas.md
---

# 39 � Shapetrax3 pattern region red mask edit

## 1. One-line purpose

This screen is the primary interface for Shapetrax3 pattern region red mask edit, allowing operators to configure, inspect, or manage related settings.
...
- "Shapetrax3 pattern region red mask edit"
...
1. Button (Text: "Shapetrax3 pattern region red mask edit"): Top left title area, expected to show a dropdown menu when clicked. Enabled.
...
The operator is currently on the Shapetrax3 pattern region red mask edit screen. They likely just navigated from the main menu or a previous tool configuration screen. Their immediate goal is to review or adjust the settings specific to Shapetrax3 pattern region red mask edit. After completing the setup, they will likely click Apply/Save and return to the main run screen or proceed to the next tool in the sequence.
...
- **Primitives mapping:** This screen configures a rule of kind matching `Shapetrax3 pattern region red mask edit` logic. ROIs are standard rectangular or polygonal shapes.

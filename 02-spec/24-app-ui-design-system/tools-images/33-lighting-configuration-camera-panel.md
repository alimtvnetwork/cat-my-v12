---
Source: assets/tools-images/33-lighting-configuration-camera-panel.jpg
Screen: Lighting configuration camera panel
Related-Spec: 03-canvas.md
---

# 33 � Lighting configuration camera panel

## 1. One-line purpose

This screen is the primary interface for Lighting configuration camera panel, allowing operators to configure, inspect, or manage related settings.
...
- "Lighting configuration camera panel"
...
1. Button (Text: "Lighting configuration camera panel"): Top left title area, expected to show a dropdown menu when clicked. Enabled.
...
The operator is currently on the Lighting configuration camera panel screen. They likely just navigated from the main menu or a previous tool configuration screen. Their immediate goal is to review or adjust the settings specific to Lighting configuration camera panel. After completing the setup, they will likely click Apply/Save and return to the main run screen or proceed to the next tool in the sequence.
...
- **Primitives mapping:** This screen configures a rule of kind matching `Lighting configuration camera panel` logic. ROIs are standard rectangular or polygonal shapes.

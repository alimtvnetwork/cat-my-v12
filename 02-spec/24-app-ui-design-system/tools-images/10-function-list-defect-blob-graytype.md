...
Screen: Function list defect blob graytype
Related-Spec: 03-canvas.md
---

# 10 � Function list defect blob graytype

## 1. One-line purpose

This screen is the primary interface for Function list defect blob graytype, allowing operators to configure, inspect, or manage related settings.
...
- "Function list defect blob graytype"
...
1. Button (Text: "Function list defect blob graytype"): Top left title area, expected to show a dropdown menu when clicked. Enabled.
...
The operator is currently on the Function list defect blob graytype screen. They likely just navigated from the main menu or a previous tool configuration screen. Their immediate goal is to review or adjust the settings specific to Function list defect blob graytype. After completing the setup, they will likely click Apply/Save and return to the main run screen or proceed to the next tool in the sequence.
...
- **Primitives mapping:** This screen configures a rule of kind matching `Function list defect blob graytype` logic. ROIs are standard rectangular or polygonal shapes.

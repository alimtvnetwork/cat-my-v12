...
Screen: Shapetrax3 reference image detection conditions
Related-Spec: 03-canvas.md
---

# 35 � Shapetrax3 reference image detection conditions

## 1. One-line purpose

This screen is the primary interface for Shapetrax3 reference image detection conditions, allowing operators to configure, inspect, or manage related settings.
...
- "Shapetrax3 reference image detection conditions"
...
1. Button (Text: "Shapetrax3 reference image detection conditions"): Top left title area, expected to show a dropdown menu when clicked. Enabled.
...
- **Primitives mapping:** This screen configures a rule of kind matching `Shapetrax3 reference image detection conditions` logic. ROIs are standard rectangular or polygonal shapes.

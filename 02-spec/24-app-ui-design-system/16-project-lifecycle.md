...
**Depends on:** `13-rule-kinds-catalogue.md`, `17-camera-setup.md`, `22-override-modes.md`, `02-spec/23-app-db/03-projects.mmd`
**Related issue:** `.ai-memory/issues/16-project-section-create-flow-broken.md`
...
2. **Camera**: bound to `02-spec/24-app-ui-design-system/17-camera-setup.md` fields plus a lighting row.

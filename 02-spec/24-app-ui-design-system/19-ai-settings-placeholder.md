...
**Status:** OUT OF SCOPE for v1. Fields BLOCKED by ambiguity Q20 in `.ai-memory/ambiguity-questions/01-ui-v2-open-questions.md`.
...
- Route: `/setup/ai`.
- Body: a single card explaining that AI verification lands in a later plan, plus a link to `.ai-memory/ambiguity-questions/01-ui-v2-open-questions.md` Q20.

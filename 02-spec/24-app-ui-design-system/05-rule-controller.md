...
**Deep dive:** `../../.ai-memory/plans/subtasks/30-app-ui-rule-editor-revamp/ss-01-rule-controller-schema.md` (normative schema)
...
Grammar frozen in `../../.ai-memory/plans/subtasks/30-app-ui-rule-editor-revamp/ss-03-math-expression-grammar.md`. Allowed: `+ - * / % ()`, comparison ops, `min/max/abs`. Forbidden: assignment, function definitions, I/O, `import`, `eval`. Any parse failure renders `--rule-error` and blocks commit.
...
`../../.ai-memory/plans/subtasks/31-pre-93-panel-gaps-completion/SS-03-panel-tokens.md`.
...
`../../.ai-memory/plans/subtasks/31-pre-93-panel-gaps-completion/SS-04-e2e-matrix.md`.

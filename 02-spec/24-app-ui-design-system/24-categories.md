...
**Depends on:** `02-spec/23-app-db/02-rule-sets.mmd`, `02-spec/23-app-db/03-projects.mmd`, endpoint rows 25, 26, 39, 40, 51, 52.
...
See `02-spec/23-app-db/02-rule-sets.mmd` and `03-projects.mmd`.

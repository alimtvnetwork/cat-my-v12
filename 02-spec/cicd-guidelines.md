...
- [ ] `02-spec/12-cicd-pipeline-workflows/01-ci-pipeline.md`
- [ ] `02-spec/12-cicd-pipeline-workflows/02-release-pipeline.md`
- [ ] `02-spec/12-cicd-pipeline-workflows/04-install-script-generation.md`
- [ ] `02-spec/12-cicd-pipeline-workflows/05-changelog-integration.md`
...
- [ ] `02-spec/14-update/04-build-scripts.md`
- [ ] `02-spec/14-update/17-release-pipeline.md`
- [ ] `02-spec/14-update/18-install-scripts.md`

### Release Engineering (`02-spec/16-generic-release`)

- [ ] `02-spec/16-generic-release/00-overview.md`
- [ ] `02-spec/16-generic-release/02-release-pipeline.md`
- [ ] `02-spec/16-generic-release/03-install-scripts.md`

...
_Wave 6 — Batch 1 (Patched): Split DB acceptance criteria with added edge cases for read-only filesystem, concurrent item creation race conditions, and locked DB files during reset._

...
>
> - **Main / Worker service** — see `02-spec/19-main-worker-service/11-split-db-tier-reconciliation.md`. Main = 3 tiers (Root/Settings/Session); Worker = 4 tiers (Root/Settings/App/Session). Cache + Document unused in v1.0.
...
_This pattern ensures consistent database organization across all projects._

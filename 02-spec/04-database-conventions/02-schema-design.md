...
**Seeding pattern** — see `14-rbac-and-status-seed.md` (`02-spec/19-main-worker-service/14-rbac-and-status-seed.md`) for the canonical seed format used by `19-main-worker-service`.
...
_Schema design — v3.4.0 — 2026-04-19. §6 wording aligned with naming-conventions v3.5.0 Rules 10/11/12._

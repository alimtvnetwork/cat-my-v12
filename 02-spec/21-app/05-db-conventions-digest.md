...
source: 02-spec/04-database-conventions/
---

# DB Conventions — Digest for Vision Inspection App

Distilled from `02-spec/04-database-conventions/` (files 00–07). Authoritative source wins on conflict.
...
- [ ] All schemas defined here appear in migrations under `02-spec/21-app/26-migrations.md` or `supabase/migrations/`.

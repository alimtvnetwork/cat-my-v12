...
First real-SDK backend behind `VendorDeviceIO` (`02-spec/21-app/50-capture-modules.md`).
...
`02-spec/21-app/40-error-manage.md` Appendix A stays authoritative.
...
- Parent scope: `02-spec/21-app/61-v2-scope.md`
- Capture anchor: `02-spec/21-app/50-capture-modules.md`
- Error taxonomy: `02-spec/21-app/40-error-manage.md` Appendix A.2

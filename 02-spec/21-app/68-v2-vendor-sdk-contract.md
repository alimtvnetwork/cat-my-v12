...
- `02-spec/21-app/62-v2-execution-order.md:44-52` - v2.0.2 exit criteria.
- `02-spec/21-app/67-v2-discovery-contract.md` - v2.0.1 discovery contract.
- `.ai-memory/plans/pending/17-v2.0.2-vendor-sdk.md` - execution plan.

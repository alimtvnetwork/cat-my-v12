...
| Target                                          | Required use                                                                                                      |
| ----------------------------------------------- | ----------------------------------------------------------------------------------------------------------------- |
| `02-spec/21-app/40-error-manage.md`                | Registers sink, store, mirror lag, corruption, and write-failure codes emitted by persistence.                    |
| `02-spec/21-app/27-config-surface.md`              | Confirms persistence path and retention/export settings are app-layer concerns, not task DB runtime overrides.    |
| `.ai-memory/memory/09-enums-and-results-shape.md` | Keeps audit event kinds and retention policy values PascalCase while allowing `E_*`, `W_*`, and `I_*` wire codes. |

...
Related: `74-worker-cli.md`, `76-cli-log-and-ipc.md`, `02-spec/05-split-db-architecture/**`, `02-spec/06-seedable-config-architecture/**`
...
- Reads seed/config per `02-spec/06-seedable-config-architecture/`.
...
7. Followed guidelines: `02-spec/02-coding-guidelines/`, `02-spec/04-database-conventions/`.
...
- Config: `config/processing.toml` layered per `02-spec/06-seedable-config-architecture/`.

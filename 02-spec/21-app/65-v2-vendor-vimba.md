...
Third real-SDK backend behind `VendorDeviceIO` (`02-spec/21-app/50-capture-modules.md`).
...
(`02-spec/21-app/63-v2-vendor-pylon.md`) and Spinnaker (`02-spec/21-app/64-v2-vendor-spinnaker.md`).
...
exception class via a `_translate(exc)` helper so `02-spec/21-app/40-error-manage.md`
...
(`02-spec/21-app/61-v2-scope.md`). Shipping code without this anchor reopens the
...
| Target                                     | Required use                                                                               |
| ------------------------------------------ | ------------------------------------------------------------------------------------------ |
| `02-spec/21-app/52-sdk-facade-pattern.md`     | Facade naming, `Cat*` boundary objects, SDK leak rules, and `E_BUG_SDK_LEAK` expectations. |
| `02-spec/21-app/67-v2-discovery-contract.md`  | Descriptor fields and `getDiscoveredDevices` output shape.                                 |
| `02-spec/21-app/68-v2-vendor-sdk-contract.md` | `Open`, `Grab`, `Close`, lifecycle states, and buffer ownership rules.                     |
| `02-spec/coding-guidelines/python.md`         | Python SDK guard, logging, and facade rules.                                               |

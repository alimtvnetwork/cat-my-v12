...
Slot 47 was chosen because slots 40-46 in `02-spec/21-app/` are already occupied. Plan 42's original text referenced 40-43; those numbers are re-mapped to 47-50 (this file + 48/49/50).
...
`ConditionType`, `PresenceMode`, `ColorMode` are the authoritative enum modules. No free-text strings; magic-string lint (`02-spec/02-coding-guidelines`) applies.

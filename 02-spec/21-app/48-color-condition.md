...
Slot 48 was chosen because slots 40-46 in `02-spec/21-app/` are already occupied (see 47 s1). Plan 42's original text referenced slot 41; that number is re-mapped to 48.

...
- **Frozen contracts:** ID conventions `SS-08-frozen-id-conventions.md`, facade additions `SS-09-facade-contract-additions.md`, surface matrix `SS-10-frozen-seed-surface-matrix.md` (all under `.ai-memory/plans/subtasks/86-ui-v4-json-seed-facade-completion/`).

...
depends_on:
  - 02-spec/21-app/62-v2-execution-order.md#v2.0.3
...
| Target                                          | Required use                                                                                                                  |
| ----------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------- |
| `02-spec/21-app/40-error-manage.md`                | Registers `E_SEC_DENIED`, `E_SEC_RATE_LIMITED`, `E_SEC_DENIAL_BURST`, `E_CFG_INVALID_SECURITY`, and `W_DENIAL_RELOAD_FAILED`. |
| `02-spec/21-app/27-config-surface.md`              | Owns the `security.denial_threshold` and `security.denial_window_seconds` keys plus admin-write constraints.                  |
| `.ai-memory/memory/09-enums-and-results-shape.md` | Keeps `DenialTuningKey` values PascalCase while preserving boundary `E_*` wire codes.                                         |

...
source: 02-spec/06-seedable-config-architecture/
---

# Seedable Config — Digest for Vision Inspection App

Distilled from `02-spec/06-seedable-config-architecture/` (00 overview, 01 fundamentals, 02 features, 03 issues, 97/98 acceptance).
...
- [ ] Every config key stated here appears in `02-spec/21-app/27-config-surface.md`.

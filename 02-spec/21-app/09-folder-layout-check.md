---
title: 02-spec/21-app Folder Layout Check
slug: folder-layout-check
source: .ai-memory/memory/07-lovable-folder-guide.md, 02-spec/01-spec-authoring-guide/07-memory-folder-guide.md
---

# 02-spec/21-app Folder Layout — Required Files Check
...
- [ ] Actual `02-spec/21-app/` tree matches the layout printed here; drift = `E_SPEC_ANCHOR_DRIFT`.

...
- Rationale: prevents divergent selection state between rail and canvas (regression source cited in `.ai-memory/memory/v2/plan35/30-slice-1.md`), and keeps the Layers-vs-Properties responsibility split from §10.1 enforceable in tests.

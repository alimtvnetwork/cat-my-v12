...
Inputs: `02-spec/21-app/61-v2-scope.md`, `.ai-memory/memory/v2/01-ranked-backlog.md`, `.ai-memory/memory/v2/02-status-audit.md`, `.ai-memory/memory/v2/03-effort-risk-scoring.md`
...
Contract: `02-spec/21-app/66-v2-vendor-discovery.md:7-33`. Seam: `app/capture/vendor_device_io.py:52,71`.
...
Anchors: `02-spec/21-app/63-v2-vendor-pylon.md`, `11-vendor-spinnaker.md`, `12-vendor-vimba.md`. Adapters: `app/capture/pylon_device_io.py:114`, `spinnaker_device_io.py:175`, `vimba_device_io.py:158`. Harness: `app/capture/perf_harness.py`.
...
Source: `.ai-memory/memory/02-naming.md`.

1. `02-spec/23-app-db/` reflects current naming (snake_case tables, singular vs plural rule, timestamp columns, RLS grant order).
2. No `app/**` or `src/**` code changed.
3. Cross-links from `.ai-memory/memory/02-naming.md` to the refreshed spec sections.
...
Any change to this sequence requires a new plan entry citing which exit criterion drove the reorder, and an update to `.ai-memory/memory/v2/03-effort-risk-scoring.md`.
...
| ------- | ----------------------------------------- | ------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------ |
| v2.0.1  | `02-spec/21-app/67-v2-discovery-contract.md` | n/a                                        | `02-spec/21-app/66-v2-vendor-discovery.md`                                                                                        |
| v2.0.2  | `02-spec/21-app/67-v2-discovery-contract.md` | `02-spec/21-app/68-v2-vendor-sdk-contract.md` | `02-spec/21-app/63-v2-vendor-pylon.md`, `64-v2-vendor-spinnaker.md`, `65-v2-vendor-vimba.md`                                      |
| v2.0.3  | n/a                                       | n/a                                        | `02-spec/21-app/69-v2-denial-tuning-contract.md` + evidence `02-spec/21-app/69a-v2-denial-tuning-evidence.md` (provisional, Plan 29) |
| v2.0.4  | n/a                                       | n/a                                        | `02-spec/21-app/71-audit-retention.md`                                                                                            |
| v2.0.5  | n/a                                       | n/a                                        | `02-spec/21-app/72-audit-persistence.md`                                                                                          |
| v2.0.6  | n/a                                       | n/a                                        | `02-spec/24-app-ui-design-system/00-overview.md`                                                                                  |
...
- [ ] Any sequence change updates this file and `.ai-memory/memory/v2/03-effort-risk-scoring.md` in the same change.
...
- [ ] Parallel-safe steps are marked and match `.ai-memory/plans/` batching.

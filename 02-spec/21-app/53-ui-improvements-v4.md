...
Status: draft
Owner: Plan 79 (see `.ai-memory/plans/pending/79-ui-improvements-v4.md`)
Reference images: `./instruction-images-v4/`
Related specs: `02-spec/24-app-ui-design-system/09-UI-improvements-v2.md`, `02-spec/21-app/47-rule-condition-model.md`, `02-spec/21-app/52-sdk-facade-pattern.md`, `02-spec/24-app-ui-design-system/14-design-mode-custom-shapes.md`
Related commands: `.ai-memory/02-spec/commands/28-ui-improvements-v4.md`
...
The user's raw brief for this pass is transcribed verbatim into `.ai-memory/02-spec/commands/28-ui-improvements-v4.md`; this spec is the normalized, engineer-facing derivation of that brief.
...
- A Rule is the atomic inspection unit. Same object the current codebase already calls "rule" (see `02-spec/21-app/47-rule-condition-model.md`). The word "recipe" is deprecated; keep the alias only in migration code.
...
Each new facade MUST also register a pending TODO under `.ai-memory/pending-facades/` describing: what the fake persistence does now, what the real SDK call should be, and the migration checklist. See Plan 79 for the exact list.
...
Plan 100 (`.ai-memory/plans/pending/82-plan100-ui-v4-100steps.md`) is the active
...
Stored under `02-spec/21-app/53-ui-improvements-v4-assets/plan82/`. Every issue
...
- `.ai-memory/issues/28-rules-list-mixes-categories.md`
- `.ai-memory/issues/29-rule-edit-does-not-open-editor.md`
- `.ai-memory/issues/30-properties-panel-not-reflecting-selection.md`
- `.ai-memory/issues/31-duplicate-breadcrumb.md`
- `.ai-memory/issues/32-tools-strip-between-header-and-canvas.md`
- `.ai-memory/issues/33-hud-does-not-follow-shape.md`
- `.ai-memory/issues/34-rule-set-fill-section-padding-broken.md`

### 12.3 Linked commands opened this round

- `.ai-memory/02-spec/commands/29-fullscreen-and-shortcut-conventions.md`
- `.ai-memory/02-spec/commands/30-inline-edit-commit-semantics.md`
- `.ai-memory/02-spec/commands/31-padding-and-readability-baseline.md`
- `.ai-memory/02-spec/commands/32-address-bar-nav.md`
- `.ai-memory/02-spec/commands/33-properties-selection-bridge.md`
- `.ai-memory/02-spec/commands/34-hud-follows-shape.md`
...
Source of truth: `.ai-memory/02-spec/commands/29-fullscreen-and-shortcut-conventions.md`.
Architecture detail: `.ai-memory/plans/subtasks/82-plan100-ui-v4-100steps/SS-01-shortcut-registry-architecture.md`.
...
Source of truth: `.ai-memory/02-spec/commands/32-address-bar-nav.md`. Fixes I-31
...
Source of truth: `.ai-memory/02-spec/commands/33-properties-selection-bridge.md`.
...
Source of truth: `.ai-memory/02-spec/commands/34-hud-follows-shape.md`. Fixes
...
Source of truth: `.ai-memory/02-spec/commands/35-seed-fixtures-per-screen.md`.
...
Source of truth: `.ai-memory/02-spec/commands/30-inline-edit-commit-semantics.md`.
...
Source of truth: `.ai-memory/02-spec/commands/31-padding-and-readability-baseline.md`.
...
`02-spec/21-app/53-ui-improvements-v4-assets/plan82/upload-71..76.png`.

## 20. Rules vs Categories separation

Source of truth: `.ai-memory/issues/28-rules-list-mixes-categories.md`. Fixes

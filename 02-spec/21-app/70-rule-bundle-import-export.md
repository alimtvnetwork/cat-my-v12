...
- Licensing feature flags this spec unblocks: `02-spec/21-app/60-licensing.md` §60.9 (`RuleBundleImport`, `RuleBundleExport`, `CloudRuleCatalogDownload`).
- Task DB shape referenced by the SQLite payload: `02-spec/21-app/22-task-db.md`.
- Rule catalog / kinds: `02-spec/21-app/33-rule-catalog.md`.
- Shape model referenced by `RuleShapes`: `02-spec/21-app/32-shape-model.md`.
- Tolerance model referenced by `RuleTolerances`: `02-spec/21-app/34-tolerance-model.md`.
- Open questions consolidated in: `02-spec/21-app/46-open-questions.md` (to be cross-linked in a follow-up execution turn per Plan 16 verification).

### Naming rules (locked)

- All enums, error types, feature flags, and format identifiers in this spec are **PascalCase, no underscores** (matches `.ai-memory/memory/09-enums-and-results-shape.md`).
...
CREATE TABLE RuleTolerances (
  ...
  key        TEXT NOT NULL,                        -- see 02-spec/21-app/34-tolerance-model.md
...
Tracked here and mirrored into `02-spec/21-app/46-open-questions.md` at the Plan 16 close-out step.
...
| Target                                          | Required use                                                                                                   |
| ----------------------------------------------- | -------------------------------------------------------------------------------------------------------------- |
| `02-spec/21-app/40-error-manage.md`                | Registers `E_BUNDLE_*` import, export, manifest, checksum, size, tier, and conflict failures.                  |
| `02-spec/21-app/27-config-surface.md`              | Confirms capture, trigger, lighting, and vendor SDK settings stay outside `.catrules` bundles.                 |
| `.ai-memory/memory/09-enums-and-results-shape.md` | Locks `BundleFormatSqlite`, `BundleFormatJson`, merge policies, origin values, and reason codes as PascalCase. |

...
lacked a dedicated `02-spec/21-app/**` section. Complements `14-capture-pipeline.md`.
...
Gap decisions from SS-01 baseline (`.ai-memory/memory/v2/plan25/00-adapter-parity-baseline.md`):
...
Any change to this surface REQUIRES a spec revision in this section plus a Blind-AI rescore of `02-spec/21-app/50,63,64,65,68`.

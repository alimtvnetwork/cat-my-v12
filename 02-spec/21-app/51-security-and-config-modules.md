...
lacked a dedicated `02-spec/21-app/**` section. Complements
...
Deep contract: `02-spec/21-app/71-audit-retention.md` (windows, category map, worker cadence, event shape). This section pins the module-level invariants only.

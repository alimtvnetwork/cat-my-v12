...
Slot 50 is free in `02-spec/21-app/` (50-52 previously reserved for capture / security / SDK-facade; 50 is the intended UI slot per Plan 42's re-map).

## 2. Non-Goals

- No new canvas / ROI drawing behavior. That surface is fixed in 31 and 32.
- No new dark-mode tokens. Uses the design tokens from `02-spec/24-app-ui-design-system/`.

...
slug: system-context
source: 02-spec/21-app/10-app-overview.md
---
...
- Open questions → `02-spec/22-app-issues/01-vision-inspection-ambiguities.md` (`AI-01`, `AI-02`, `AI-06`).
...
- [ ] No PII crosses the boundary without appearing in `02-spec/21-app/44-security-privacy.md`.

...
Second real-SDK backend behind `VendorDeviceIO` (`02-spec/21-app/50-capture-modules.md`).
...
taxonomy in `02-spec/21-app/40-error-manage.md` Appendix A stays authoritative:

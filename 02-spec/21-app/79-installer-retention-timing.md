...
Status: draft (v0.1)
Owner: DevEx / Ops
Depends on: `78-retention-schedule.md`, `77-cli-powershell-and-release.md`, `02-spec/11-powershell-integration/03-integration-guide.md`
Plan 90 Step 103.
...
- `02-spec/21-app/79-installer-retention-timing.md` (this file)

...
source: 02-spec/21-app/11-system-context.md
---
...
- [ ] IPC channels named with schema anchor to `02-spec/21-app/24-results-json.md` or migrations.
- [ ] Crash + restart semantics reference `02-spec/21-app/40-error-manage.md` tiers.

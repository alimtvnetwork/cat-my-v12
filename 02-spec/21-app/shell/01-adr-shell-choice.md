...
Supersedes: TBD markers in `02-spec/21-app/10-app-overview.md`,
`02-spec/21-app/11-system-context.md`, `02-spec/21-app/03-glossary.md`.
...
and support self-update via `02-spec/14-update/*`. Open question AI-01 required a
...
- Self-update via Tauri updater feed, verified against a project-owned Ed25519
  key; migration hooks ordered per `02-spec/14-update/*`.

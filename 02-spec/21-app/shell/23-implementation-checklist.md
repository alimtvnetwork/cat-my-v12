...
Companion: `.ai-memory/plans/subtasks/28-chromium-shell-spec/ss-05-implementation-checklist.md`
...
Per `02-spec/16-generic-release/`. SBOM + license inventory attached; changelog updated.

## Definition of done

- No row unmarked.
- Every acceptance test cited above is green in CI on all three OSes.
- Blind-AI rescore of `02-spec/21-app/shell/` ≥ 100/100.

# Self-update binding (to 02-spec/14-update)

Status: Draft (Plan 28)
Companion: `./diagrams/05-update-flow.mmd`
Governing spec: `02-spec/14-update/*`
...
- Manifest schema: per `02-spec/14-update/` (version, url, sha256, signature, notes).

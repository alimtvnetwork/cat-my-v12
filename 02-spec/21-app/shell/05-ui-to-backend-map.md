...
- **Codes** — success `I_*` + failure `E_*` codes (registered in `02-spec/21-app/40-error-manage.md`).
...
a UUIDv4 the caller mints; `code` is registered in `02-spec/21-app/40-error-manage.md`.

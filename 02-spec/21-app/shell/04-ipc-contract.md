...
Schema source of truth: `02-spec/21-app/shell/schemas/ipc/*.json` (created during implementation)
...
Every `code` MUST be registered in `02-spec/21-app/40-error-manage.md` and

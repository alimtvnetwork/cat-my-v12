...
Terms used across `02-spec/21-app/shell/*`. Definitions are authoritative for this spec; when a term also appears in `02-spec/14-update/*` or `02-spec/21-app/*`, the definition here matches those.

...
source: 02-spec/05-split-db-architecture/
---

# Split-DB Architecture — Digest for Vision Inspection App

Distilled from `02-spec/05-split-db-architecture/` (00 overview, 01 fundamentals, 02 features, 03 issues, 97/98 acceptance).
...
- [ ] Zero cross-DB joins asserted; enforced by test named in `02-spec/21-app/45-testing-strategy.md`.

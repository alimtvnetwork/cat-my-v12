...
```html
<div class="code-block-wrapper my-5" style="--lang-accent: {HSL_VALUE}" data-block-id="{ID}">
  <!-- HEADER -->
  <div class="code-block-header">
    ...
    <div class="code-header-right">
      ...
      <!-- Download button -->
      <button
        class="code-tool-btn download-code-btn"
...
_HTML Structure — updated: 2026-04-08_

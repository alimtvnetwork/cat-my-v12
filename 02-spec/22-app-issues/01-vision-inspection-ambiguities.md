...
Reserved by Plan 04 Step 8. Each unresolved question surfaced during spec authoring is filed here as `02-spec/22-app-issues/AI-<nn>-<slug>.md`. This overview tracks the shortlist so downstream steps have one place to look before assuming a default.

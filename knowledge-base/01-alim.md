...
- Read the .ai-memory folder and all other related files that it mentions, and also the root README file.
...
- `.ai-memory/`: Tracks AI planning, memory, strict rules (`.ai-memory/memory/01-code-red.md`), and prompts. It serves as an open operating manual for AI agents.
- `02-spec/`: Extensive product and engineering specifications (e.g., error management, database conventions, design system).
...
- Errors must never be swallowed and must follow the `02-spec/03-error-manage/` envelope.

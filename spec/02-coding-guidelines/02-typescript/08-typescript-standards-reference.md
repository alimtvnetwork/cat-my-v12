...
type Action = { type: "ADD_TOAST"; toast: ToasterToast } | { type: "DISMISS"; toastId?: string };
...
_TypeScript standards v3.2.0 — generics-first, zero-any, no-magic-strings, max-15-lines, zero-nesting, isDefined-guards — 2026-02-25_

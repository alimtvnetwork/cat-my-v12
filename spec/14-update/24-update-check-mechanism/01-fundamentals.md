...
2. **HTTP 404** on either the repo or the file is treated as
   _not-found_. No retry.
3. **HTTP 200** with valid JSON is treated as _found_.
4. **HTTP 200 with malformed JSON** is treated as _not-found_ and the
...
_Fundamentals — v1.0.0 — 2026-04-20_

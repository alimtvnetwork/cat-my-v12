...
- [ ] System purpose stated in one paragraph, matching README banner.
- [ ] Every subsystem referenced (capture, processing, UI, security, audit) links to its owning spec.
- [ ] No implementation detail leaked here — belongs in 10-17.

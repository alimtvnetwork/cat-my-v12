...
Patterns 01–08 give a repo the _building blocks_ (guards, runner,
...
jobs:
  guards:
    uses: alimtvnetwork/coding-guidelines-v24/.github/workflow-templates/ci-guards.reusable.yml@v3.44.0
    with:
      phase: all
      languages: "go"
      file-glob: "*.go"
...
_Workflow templates — v1.0.0 — 2026-04-21_

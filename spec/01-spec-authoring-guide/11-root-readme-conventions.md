...
```html
<p align="center">
  <strong>By <a href="https://alimkarim.com/">Md. Alim Ul Karim</a></strong> — Chief Software
  Engineer, <a href="https://riseup-asia.com/">Riseup Asia LLC</a><br />
...
_"What does it look like? → How do I install it? → What is it really? →
How do I use it? → Who made it?"_
...
| 4   | 🛠️ Install Scripts                              | ❌                   | One-liner installers FIRST (curl/iwr commands), THEN the per-bundle matrix, THEN the flag table. Readers want to _try it_ before reading prose                                                                                                     |
...
2. **Install before explanation** — most readers arrive wanting to _try_
...
3. **About in the middle** — once the reader has seen it work and knows
   how to install it, they're ready to invest in the _why_ and the
   _story_. The About heading and intro paragraph MUST be centered;
...
- Sync script: `scripts/sync-readme-stats.mjs`
...
_Root README Conventions — v1.0.0 — 2026-04-22_

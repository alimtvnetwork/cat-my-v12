...
| `CAT`   | Control Automation UI structured codes | String codes (`E_LAYER_*`, `W_LAYER_*`, `I_UI_*`) | `spec/21-app/40-error-manage.md`, `spec/24-app-ui-design-system/07-errors-logging.md` | ✅ Active                                       |

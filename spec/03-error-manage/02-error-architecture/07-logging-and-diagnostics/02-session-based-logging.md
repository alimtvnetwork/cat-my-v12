...
```json
{
  ...
  "data": {
    ...
    "StackTrace": {
      "golang": [
        {
          "function": "handlers.init.handleSiteActionById.func63",
          "file": "handler_factory.go",
          "line": 107
        },
        {
          "function": "api.NewServer.SessionLogging.func3.1",
...
_Specification created: 2026-02-06 | Updated: 2026-02-11 (v2.0.0 — DelegatedRequestServer, session-error linkage)_

...
Screen: Program menu change save delete
Related-Spec: 03-canvas.md
---

# 43 � Program menu change save delete

## 1. One-line purpose

This screen is the primary interface for Program menu change save delete, allowing operators to configure, inspect, or manage related settings.
...
- "Program menu change save delete"
...
1. Button (Text: "Program menu change save delete"): Top left title area, expected to show a dropdown menu when clicked. Enabled.
...
The operator is currently on the Program menu change save delete screen. They likely just navigated from the main menu or a previous tool configuration screen. Their immediate goal is to review or adjust the settings specific to Program menu change save delete. After completing the setup, they will likely click Apply/Save and return to the main run screen or proceed to the next tool in the sequence.
...
- **Primitives mapping:** This screen configures a rule of kind matching `Program menu change save delete` logic. ROIs are standard rectangular or polygonal shapes.

...
Screen: Edit tools copy paste add cam menu
Related-Spec: 03-canvas.md
---

# 47 — Edit tools copy paste add cam menu

## 1. One-line purpose
This screen is the primary interface for Edit tools copy paste add cam menu, allowing operators to configure, inspect, or manage related settings.
...
**Titlebar:**
- "Edit tools copy paste add cam menu"
...
1. Button (Text: "Edit tools copy paste add cam menu"): Top left title area, expected to show a dropdown menu when clicked. Enabled.
...
The operator is currently on the Edit tools copy paste add cam menu screen. They likely just navigated from the main menu or a previous tool configuration screen. Their immediate goal is to review or adjust the settings specific to Edit tools copy paste add cam menu. After completing the setup, they will likely click Apply/Save and return to the main run screen or proceed to the next tool in the sequence.
...
- **Primitives mapping:** This screen configures a rule of kind matching `Edit tools copy paste add cam menu` logic. ROIs are standard rectangular or polygonal shapes.

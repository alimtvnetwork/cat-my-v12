...
Screen: System information controller serial details
Related-Spec: 03-canvas.md
---

# 44 — System information controller serial details

## 1. One-line purpose
This screen is the primary interface for System information controller serial details, allowing operators to configure, inspect, or manage related settings.
...
**Titlebar:**
- "System information controller serial details"
...
1. Button (Text: "System information controller serial details"): Top left title area, expected to show a dropdown menu when clicked. Enabled.
...
The operator is currently on the System information controller serial details screen. They likely just navigated from the main menu or a previous tool configuration screen. Their immediate goal is to review or adjust the settings specific to System information controller serial details. After completing the setup, they will likely click Apply/Save and return to the main run screen or proceed to the next tool in the sequence.
...
- **Primitives mapping:** This screen configures a rule of kind matching `System information controller serial details` logic. ROIs are standard rectangular or polygonal shapes.

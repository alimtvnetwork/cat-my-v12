...
Screen: Function list shapetrax3 description
Related-Spec: 03-canvas.md
---

# 16 � Function list shapetrax3 description

## 1. One-line purpose

This screen is the primary interface for Function list shapetrax3 description, allowing operators to configure, inspect, or manage related settings.
...
- "Function list shapetrax3 description"
...
1. Button (Text: "Function list shapetrax3 description"): Top left title area, expected to show a dropdown menu when clicked. Enabled.
...
The operator is currently on the Function list shapetrax3 description screen. They likely just navigated from the main menu or a previous tool configuration screen. Their immediate goal is to review or adjust the settings specific to Function list shapetrax3 description. After completing the setup, they will likely click Apply/Save and return to the main run screen or proceed to the next tool in the sequence.
...
- **Primitives mapping:** This screen configures a rule of kind matching `Function list shapetrax3 description` logic. ROIs are standard rectangular or polygonal shapes.

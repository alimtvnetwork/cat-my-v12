...
Screen: Shapetrax3 pattern region red roi
Related-Spec: 03-canvas.md
---

# 38 — Shapetrax3 pattern region red roi

## 1. One-line purpose
This screen is the primary interface for Shapetrax3 pattern region red roi, allowing operators to configure, inspect, or manage related settings.
...
**Titlebar:**
- "Shapetrax3 pattern region red roi"
...
1. Button (Text: "Shapetrax3 pattern region red roi"): Top left title area, expected to show a dropdown menu when clicked. Enabled.
...
The operator is currently on the Shapetrax3 pattern region red roi screen. They likely just navigated from the main menu or a previous tool configuration screen. Their immediate goal is to review or adjust the settings specific to Shapetrax3 pattern region red roi. After completing the setup, they will likely click Apply/Save and return to the main run screen or proceed to the next tool in the sequence.
...
- **Primitives mapping:** This screen configures a rule of kind matching `Shapetrax3 pattern region red roi` logic. ROIs are standard rectangular or polygonal shapes.

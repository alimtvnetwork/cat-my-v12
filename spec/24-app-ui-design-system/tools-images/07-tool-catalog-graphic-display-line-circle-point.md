...
Screen: Tool catalog graphic display line circle point
Related-Spec: 03-canvas.md
---

# 07 — Tool catalog graphic display line circle point

## 1. One-line purpose
This screen is the primary interface for Tool catalog graphic display line circle point, allowing operators to configure, inspect, or manage related settings.
...
**Titlebar:**
- "Tool catalog graphic display line circle point"
...
1. Button (Text: "Tool catalog graphic display line circle point"): Top left title area, expected to show a dropdown menu when clicked. Enabled.
...
The operator is currently on the Tool catalog graphic display line circle point screen. They likely just navigated from the main menu or a previous tool configuration screen. Their immediate goal is to review or adjust the settings specific to Tool catalog graphic display line circle point. After completing the setup, they will likely click Apply/Save and return to the main run screen or proceed to the next tool in the sequence.
...
- **Primitives mapping:** This screen configures a rule of kind matching `Tool catalog graphic display line circle point` logic. ROIs are standard rectangular or polygonal shapes.

...
Screen: Hmi main run screen measurement list
Related-Spec: 03-canvas.md
---

# 01 — Hmi main run screen measurement list

## 1. One-line purpose
This screen is the primary interface for Hmi main run screen measurement list, allowing operators to configure, inspect, or manage related settings.
...
**Titlebar:**
- "Hmi main run screen measurement list"
...
1. Button (Text: "Hmi main run screen measurement list"): Top left title area, expected to show a dropdown menu when clicked. Enabled.
...
The operator is currently on the Hmi main run screen measurement list screen. They likely just navigated from the main menu or a previous tool configuration screen. Their immediate goal is to review or adjust the settings specific to Hmi main run screen measurement list. After completing the setup, they will likely click Apply/Save and return to the main run screen or proceed to the next tool in the sequence.
...
- **Primitives mapping:** This screen configures a rule of kind matching `Hmi main run screen measurement list` logic. ROIs are standard rectangular or polygonal shapes.

...
Screen: Function list auto teach imp patterntrax
Related-Spec: 03-canvas.md
---

# 23 — Function list auto teach imp patterntrax

## 1. One-line purpose
This screen is the primary interface for Function list auto teach imp patterntrax, allowing operators to configure, inspect, or manage related settings.
...
**Titlebar:**
- "Function list auto teach imp patterntrax"
...
1. Button (Text: "Function list auto teach imp patterntrax"): Top left title area, expected to show a dropdown menu when clicked. Enabled.
...
The operator is currently on the Function list auto teach imp patterntrax screen. They likely just navigated from the main menu or a previous tool configuration screen. Their immediate goal is to review or adjust the settings specific to Function list auto teach imp patterntrax. After completing the setup, they will likely click Apply/Save and return to the main run screen or proceed to the next tool in the sequence.
...
- **Primitives mapping:** This screen configures a rule of kind matching `Function list auto teach imp patterntrax` logic. ROIs are standard rectangular or polygonal shapes.

...
Screen: System license general public license
Related-Spec: 03-canvas.md
---

# 45 — System license general public license

## 1. One-line purpose
This screen is the primary interface for System license general public license, allowing operators to configure, inspect, or manage related settings.
...
**Titlebar:**
- "System license general public license"
...
1. Button (Text: "System license general public license"): Top left title area, expected to show a dropdown menu when clicked. Enabled.
...
The operator is currently on the System license general public license screen. They likely just navigated from the main menu or a previous tool configuration screen. Their immediate goal is to review or adjust the settings specific to System license general public license. After completing the setup, they will likely click Apply/Save and return to the main run screen or proceed to the next tool in the sequence.
...
- **Primitives mapping:** This screen configures a rule of kind matching `System license general public license` logic. ROIs are standard rectangular or polygonal shapes.

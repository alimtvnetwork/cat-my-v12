...
Screen: Communications io system settings menu
Related-Spec: 03-canvas.md
---

# 46 — Communications io system settings menu

## 1. One-line purpose
This screen is the primary interface for Communications io system settings menu, allowing operators to configure, inspect, or manage related settings.
...
**Titlebar:**
- "Communications io system settings menu"
...
1. Button (Text: "Communications io system settings menu"): Top left title area, expected to show a dropdown menu when clicked. Enabled.
...
The operator is currently on the Communications io system settings menu screen. They likely just navigated from the main menu or a previous tool configuration screen. Their immediate goal is to review or adjust the settings specific to Communications io system settings menu. After completing the setup, they will likely click Apply/Save and return to the main run screen or proceed to the next tool in the sequence.
...
- **Primitives mapping:** This screen configures a rule of kind matching `Communications io system settings menu` logic. ROIs are standard rectangular or polygonal shapes.

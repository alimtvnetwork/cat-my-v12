...
Screen: Function list patterntrax description
Related-Spec: 03-canvas.md
---

# 17 — Function list patterntrax description

## 1. One-line purpose
This screen is the primary interface for Function list patterntrax description, allowing operators to configure, inspect, or manage related settings.
...
**Titlebar:**
- "Function list patterntrax description"
...
1. Button (Text: "Function list patterntrax description"): Top left title area, expected to show a dropdown menu when clicked. Enabled.
...
The operator is currently on the Function list patterntrax description screen. They likely just navigated from the main menu or a previous tool configuration screen. Their immediate goal is to review or adjust the settings specific to Function list patterntrax description. After completing the setup, they will likely click Apply/Save and return to the main run screen or proceed to the next tool in the sequence.
...
- **Primitives mapping:** This screen configures a rule of kind matching `Function list patterntrax description` logic. ROIs are standard rectangular or polygonal shapes.

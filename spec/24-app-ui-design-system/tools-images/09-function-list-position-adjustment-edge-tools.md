...
Screen: Function list position adjustment edge tools
Related-Spec: 03-canvas.md
---

# 09 — Function list position adjustment edge tools

## 1. One-line purpose
This screen is the primary interface for Function list position adjustment edge tools, allowing operators to configure, inspect, or manage related settings.
...
**Titlebar:**
- "Function list position adjustment edge tools"
...
1. Button (Text: "Function list position adjustment edge tools"): Top left title area, expected to show a dropdown menu when clicked. Enabled.
...
The operator is currently on the Function list position adjustment edge tools screen. They likely just navigated from the main menu or a previous tool configuration screen. Their immediate goal is to review or adjust the settings specific to Function list position adjustment edge tools. After completing the setup, they will likely click Apply/Save and return to the main run screen or proceed to the next tool in the sequence.
...
- **Primitives mapping:** This screen configures a rule of kind matching `Function list position adjustment edge tools` logic. ROIs are standard rectangular or polygonal shapes.

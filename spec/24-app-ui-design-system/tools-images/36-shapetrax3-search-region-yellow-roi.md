...
Screen: Shapetrax3 search region yellow roi
Related-Spec: 03-canvas.md
---

# 36 — Shapetrax3 search region yellow roi

## 1. One-line purpose
This screen is the primary interface for Shapetrax3 search region yellow roi, allowing operators to configure, inspect, or manage related settings.
...
**Titlebar:**
- "Shapetrax3 search region yellow roi"
...
1. Button (Text: "Shapetrax3 search region yellow roi"): Top left title area, expected to show a dropdown menu when clicked. Enabled.
...
The operator is currently on the Shapetrax3 search region yellow roi screen. They likely just navigated from the main menu or a previous tool configuration screen. Their immediate goal is to review or adjust the settings specific to Shapetrax3 search region yellow roi. After completing the setup, they will likely click Apply/Save and return to the main run screen or proceed to the next tool in the sequence.
...
- **Primitives mapping:** This screen configures a rule of kind matching `Shapetrax3 search region yellow roi` logic. ROIs are standard rectangular or polygonal shapes.

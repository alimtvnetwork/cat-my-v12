...
Screen: Preferred tool presence black white specific area
Related-Spec: 03-canvas.md
---

# 14 — Preferred tool presence black white specific area

## 1. One-line purpose
This screen is the primary interface for Preferred tool presence black white specific area, allowing operators to configure, inspect, or manage related settings.
...
**Titlebar:**
- "Preferred tool presence black white specific area"
...
1. Button (Text: "Preferred tool presence black white specific area"): Top left title area, expected to show a dropdown menu when clicked. Enabled.
...
The operator is currently on the Preferred tool presence black white specific area screen. They likely just navigated from the main menu or a previous tool configuration screen. Their immediate goal is to review or adjust the settings specific to Preferred tool presence black white specific area. After completing the setup, they will likely click Apply/Save and return to the main run screen or proceed to the next tool in the sequence.
...
- **Primitives mapping:** This screen configures a rule of kind matching `Preferred tool presence black white specific area` logic. ROIs are standard rectangular or polygonal shapes.

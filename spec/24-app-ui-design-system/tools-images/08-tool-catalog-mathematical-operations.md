...
## 1. One-line purpose
This screen is the primary interface for Tool catalog mathematical operations, allowing operators to configure, inspect, or manage related settings.
...
**Titlebar:**
- "Tool catalog mathematical operations"
...
1. Button (Text: "Tool catalog mathematical operations"): Top left title area, expected to show a dropdown menu when clicked. Enabled.
...
The operator is currently on the Tool catalog mathematical operations screen. They likely just navigated from the main menu or a previous tool configuration screen. Their immediate goal is to review or adjust the settings specific to Tool catalog mathematical operations. After completing the setup, they will likely click Apply/Save and return to the main run screen or proceed to the next tool in the sequence.
...
- **Primitives mapping:** This screen configures a rule of kind matching `Tool catalog mathematical operations` logic. ROIs are standard rectangular or polygonal shapes.
